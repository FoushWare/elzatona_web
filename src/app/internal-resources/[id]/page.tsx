            ...
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <p className="text-gray-600">
                  {resource.videoDescription || "Watch this video to learn the concepts before practicing."}
                </p>
              </div>
              <button
        ...
        {resource.videoUrl && !showVideo && videoWatched && (
          <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-8">
            <div className="flex items-center">
              ...
              <span className="text-green-800 font-medium">Video watched - Ready for practice!</span>
              <button
            ...
            <div className="flex flex-wrap gap-2 max-w-full overflow-x-auto">
              ...
              <div className="flex sm:hidden items-center gap-2">
                ...
                <button
                  ...
                  disabled={currentQuestionIndex === resource.questions.length - 1}
                  className={`p-2 rounded-lg ${
