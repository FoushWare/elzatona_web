...
export default function InternalResourcesPage() {
  ...
  const handleFilterChange = (
    newFilter: string,
    filterType: "category" | "difficulty" | "search"
  ) => {
    setCurrentPage(1);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-700 mb-8">
            Comprehensive learning materials and practice questions for frontend
            development
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  handleFilterChange(e.target.value, "difficulty")
                }
                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              >
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <div className="bg-white rounded-lg shadow-sm p-6 text-center">
            ...
            <div className="text-gray-700 font-medium">Total Resources</div>
          </div>
          <div className="bg-white rounded-lg shadow-sm p-6 text-center">
          ...
          <div className="bg-white rounded-lg shadow-sm p-6 text-center">
            ...
            <div className="text-gray-700 font-medium">Total Minutes</div>
          </div>
          <div className="bg-white rounded-lg shadow-sm p-6 text-center">
