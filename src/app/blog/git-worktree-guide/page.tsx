        ...
        <div className="container mx-auto px-4 py-8">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground mb-8">
              A comprehensive guide to Git worktrees - the powerful feature that allows you to work on multiple branches simultaneously without stashing or committing incomplete work.
            </p>
        ...
        <div className="max-w-4xl mx-auto prose prose-lg dark:prose-invert max-w-none">
          ...
          <div className="bg-card border border-border rounded-lg p-6 mb-8">
            ...
            <ul className="space-y-2 text-muted-foreground">
              <li><a href="#what-is-worktree" className="text-blue-600 dark:text-blue-400 hover:underline">What is Git Worktree?</a></li>
              <li><a href="#why-use-worktree" className="text-blue-600 dark:text-blue-400 hover:underline">Why Use Git Worktree?</a></li>
              <li><a href="#basic-commands" className="text-blue-600 dark:text-blue-400 hover:underline">Basic Worktree Commands</a></li>
              <li><a href="#practical-examples" className="text-blue-600 dark:text-blue-400 hover:underline">Practical Examples</a></li>
              <li><a href="#advanced-usage" className="text-blue-600 dark:text-blue-400 hover:underline">Advanced Usage Patterns</a></li>
          ...
          <section id="what-is-worktree">
            ...
            <p className="text-lg text-muted-foreground mb-6">
              Git worktree is a feature that allows you to check out multiple branches simultaneously in different directories. 
              Unlike the traditional Git workflow where you can only have one branch checked out at a time, worktrees enable 
              you to work on multiple branches without switching between them.
            </p>
            ...
            <div className="bg-yellow-50 dark:bg-yellow-950/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-6 mb-6">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-yellow-800 dark:text-yellow-200 mb-2">Key Concept</h3>
                  <p className="text-yellow-700 dark:text-yellow-300">
                    A worktree is essentially a separate working directory that points to a specific branch. 
                    You can have multiple worktrees, each pointing to different branches, allowing you to work 
            ...
            {/* Worktree Diagram */}
            <div className="bg-card border border-border rounded-lg p-6 mb-8">
              <h3 className="text-xl font-semibold text-foreground mb-4">Worktree Structure Diagram</h3>
              <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-6 font-mono text-sm">
                <div className="space-y-4">
                  <div className="flex items-center gap-4">
                    <span className="text-blue-600 dark:text-blue-400">📁 Project Root</span>
                    <span className="text-gray-500">→</span>
                    <span className="text-green-600 dark:text-green-400">main branch (primary worktree)</span>
                  </div>
                  <div className="ml-8 space-y-2">
                    <div className="flex items-center gap-4">
                      <span className="text-purple-600 dark:text-purple-400">📁 feature-branch/</span>
                      <span className="text-gray-500">→</span>
                      <span className="text-green-600 dark:text-green-400">feature-branch (linked worktree)</span>
                    </div>
                    <div className="flex items-center gap-4">
                      <span className="text-purple-600 dark:text-purple-400">📁 hotfix-branch/</span>
                      <span className="text-gray-500">→</span>
                      <span className="text-green-600 dark:text-green-400">hotfix-branch (linked worktree)</span>
                    </div>
                    <div className="flex items-center gap-4">
                      <span className="text-purple-600 dark:text-purple-400">📁 experimental/</span>
                      <span className="text-gray-500">→</span>
                      <span className="text-green-600 dark:text-green-400">experimental-branch (linked worktree)</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <section id="why-use-worktree">
            <h2 className="text-3xl font-bold text-foreground mb-6">Why Use Git Worktree?</h2>
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              ...
              <div className="bg-card border border-border rounded-lg p-6">
                ...
                <ul className="space-y-3 text-muted-foreground">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-yellow-500 mt-1">⚠</span>
                    <span>Potential for confusion with multiple directories</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-yellow-500 mt-1">⚠</span>
          ...
          <section id="basic-commands">
            <h2 className="text-3xl font-bold text-foreground mb-6">Basic Worktree Commands</h2>
            
            <div className="space-y-6">
              <div className="bg-card border border-border rounded-lg p-6">
                <h3 className="text-xl font-semibold text-foreground mb-4">1. List Worktrees</h3>
              ...
              <div className="bg-card border border-border rounded-lg p-6">
                <h3 className="text-xl font-semibold text-foreground mb-4">2. Add a New Worktree</h3>
                <div className="bg-gray-900 text-green-400 rounded-lg p-4 font-mono text-sm overflow-x-auto">
                  <code>git worktree add ../feature-branch feature-branch</code>
                </div>
                <p className="text-muted-foreground mt-3">
                  Creates a new worktree for the specified branch in the specified directory.
                </p>
              </div>

              <div className="bg-card border border-border rounded-lg p-6">
                <h3 className="text-xl font-semibold text-foreground mb-4">3. Create and Checkout New Branch</h3>
                <div className="bg-gray-900 text-green-400 rounded-lg p-4 font-mono text-sm overflow-x-auto">
                  <code>git worktree add -b new-feature ../new-feature main</code>
                </div>
                <p className="text-muted-foreground mt-3">
              ...
              <div className="bg-card border border-border rounded-lg p-6">
                <h3 className="text-xl font-semibold text-foreground mb-4">4. Remove a Worktree</h3>
                <div className="bg-gray-900 text-green-400 rounded-lg p-4 font-mono text-sm overflow-x-auto">
                  <code>git worktree remove ../feature-branch</code>
                </div>
                <p className="text-muted-foreground mt-3">
                  Removes the worktree and its directory. The branch remains in the repository.
                </p>
              </div>

              <div className="bg-card border border-border rounded-lg p-6">
                <h3 className="text-xl font-semibold text-foreground mb-4">5. Prune Worktrees</h3>
                <div className="bg-gray-900 text-green-400 rounded-lg p-4 font-mono text-sm overflow-x-auto">
          ...
          <section id="practical-examples">
            ...
            <div className="space-y-8">
              <div className="bg-card border border-border rounded-lg p-6">
                <h3 className="text-xl font-semibold text-foreground mb-4">Example 1: Feature Development Workflow</h3>
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                    <h4 className="font-semibold text-blue-800 dark:text-blue-200 mb-2">Workflow Benefits:</h4>
              ...
              <div className="bg-card border border-border rounded-lg p-6">
                <h3 className="text-xl font-semibold text-foreground mb-4">Example 2: Hotfix Scenario</h3>
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-green-50 dark:bg-green-950/20 border border-green-200 dark:border-green-800 rounded-lg p-4">
                    <h4 className="font-semibold text-green-800 dark:text-green-200 mb-2">Hotfix Advantages:</h4>
          ...
          <section id="advanced-usage">
            <h2 className="text-3xl font-bold text-foreground mb-6">Advanced Usage Patterns</h2>
            
            <div className="space-y-6">
              <div className="bg-card border border-border rounded-lg p-6">
                <h3 className="text-xl font-semibold text-foreground mb-4">Temporary Worktrees</h3>
                <div className="bg-gray-900 text-green-400 rounded-lg p-4 font-mono text-sm overflow-x-auto">
                  <div># Create temporary worktree for quick testing</div>
                  <div>git worktree add --detach ../temp-test HEAD</div>
                  <br />
                  <div># Worktree is automatically removed when you're done</div>
              ...
              <div className="bg-card border border-border rounded-lg p-6">
                <h3 className="text-xl font-semibold text-foreground mb-4">Worktree with Specific Commit</h3>
                <div className="bg-gray-900 text-green-400 rounded-lg p-4 font-mono text-sm overflow-x-auto">
              ...
              <div className="bg-card border border-border rounded-lg p-6">
                <h3 className="text-xl font-semibold text-foreground mb-4">Worktree Locking</h3>
                <div className="bg-gray-900 text-green-400 rounded-lg p-4 font-mono text-sm overflow-x-auto">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="bg-card border border-border rounded-lg p-6">
                ...
                <ul className="space-y-3 text-muted-foreground">
                  ...
                  <li>• Don't modify the same files in multiple worktrees</li>
            ...
            <div className="space-y-6">
              <div className="bg-card border border-border rounded-lg p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-foreground mb-2">Issue: "worktree already exists"</h4>
                    <div className="bg-gray-900 text-green-400 rounded-lg p-4 font-mono text-sm overflow-x-auto">
                      <div># Remove existing worktree first</div>
                      <div>git worktree remove ../worktree-name</div>
                      <div># Or use force flag</div>
                      <div>git worktree add --force ../worktree-name branch-name</div>
                    </div>
                  </div>

                  <div>
                    <h4 className="font-semibold text-foreground mb-2">Issue: "branch is already checked out"</h4>
                    <div className="bg-gray-900 text-green-400 rounded-lg p-4 font-mono text-sm overflow-x-auto">
                      <div># Check where the branch is checked out</div>
                      <div>git worktree list</div>
                      <div># Remove the existing worktree or use different branch</div>
          ...
          <section className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-950/20 dark:to-purple-950/20 rounded-lg p-8 mt-12">
            ...
            <p className="text-lg text-muted-foreground mb-6">
              Git worktrees are a powerful feature that can significantly improve your development workflow. 
              They allow you to work on multiple branches simultaneously, handle hotfixes efficiently, and 
              maintain a clean development environment. By following the best practices outlined in this guide, 
              you can leverage worktrees to boost your productivity and streamline your Git workflow.
            </p>
