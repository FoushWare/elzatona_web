...
const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    excerpt:
      'A comprehensive guide covering everything you need to know for frontend interviews, from basic concepts to advanced topics.',
    author: 'KodDev Team',
    date: '2024-01-14',
    readTime: '15 min read',
    category: 'interview',
  ...
  },
  {
    ...
    excerpt:
      'Learn advanced techniques to optimize React applications, including memoization, code splitting, and bundle optimization.',
    author: 'KodDev Team',
    date: '2024-01-10',
  ...
  },
  {
    ...
    excerpt:
      'Explore modern CSS features like Grid, Flexbox, and CSS Custom Properties to create responsive and maintainable layouts.',
    author: 'KodDev Team',
    date: '2024-01-05',
  ...
  },
  {
    ...
    excerpt:
      'Essential JavaScript concepts and questions that frequently appear in frontend interviews, with detailed explanations.',
    author: 'KodDev Team',
    date: '2024-01-01',
  ...
  // Curated External Articles
  {
    ...
    excerpt:
      'Why testing implementation details can lead to brittle tests and how to focus on testing behavior instead.',
    author: 'Kent C. Dodds',
    date: '2024-01-12',
    readTime: '8 min read',
    category: 'frontend',
  ...
  },
  {
    ...
    excerpt:
      'Everything you need to know about useEffect, from basic usage to advanced patterns and common pitfalls.',
    author: 'Kent C. Dodds',
    date: '2024-01-08',
  ...
  },
  {
    ...
    excerpt:
      'A detailed comparison of React Hook Form and Formik, helping you choose the right form library for your project.',
    author: 'Kent C. Dodds',
    date: '2024-01-05',
    readTime: '12 min read',
    category: 'react',
  ...
  },
  {
    ...
    excerpt:
      'Practical tips and techniques for making React applications more accessible to users with disabilities.',
    author: 'Kent C. Dodds',
    date: '2024-01-02',
    readTime: '15 min read',
    category: 'frontend',
  ...
  },
  {
    ...
    excerpt:
      'A comprehensive guide to CSS Grid Layout, covering all properties and practical examples for modern layouts.',
    author: 'CSS-Tricks',
    date: '2024-01-10',
  ...
  },
  {
    ...
    excerpt:
      'Master JavaScript Promises with practical examples, error handling, and advanced patterns for async programming.',
  ...
  },
  {
    ...
    excerpt:
      'Essential performance optimization techniques for React applications, from rendering optimization to bundle size reduction.',
    author: 'React Blog',
    date: '2024-01-03',
  ...
  },
  {
    ...
    excerpt:
      'Explore different architectural patterns for building scalable frontend applications, from monoliths to micro-frontends.',
    ...
    externalUrl:
      'https://frontendmasters.com/blog/frontend-architecture-patterns/',
    isExternal: true,
  },
];
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 mb-8">
              Curated articles and original content for frontend interview
            ...
            <div className="mb-6">
              ...
              <div
                className={`flex justify-center gap-8 transition-all duration-300 ${
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* Filters */}
        <div
          className={`bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 mb-8 transition-all duration-300 ${
            ...
            <div className="flex gap-2 flex-wrap">
              {[
                ...
                <button
                  ...
                  onClick={() =>
                    setSelectedCategory(
                      category as BlogPost['category'] | 'all'
                    )
                  }
