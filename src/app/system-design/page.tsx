...
const systemDesignFeatures: SystemDesignFeature[] = [
  {
    ...
    description: "Design a real-time news feed system that shows personalized content to millions of users with low latency and high availability.",
    ...
    relatedTopics: ["Real-time Systems", "Personalization", "Caching Strategies"]
  },
  {
    id: "netflix-streaming",
    title: "Netflix Video Streaming",
    description: "Build a video streaming platform that can serve millions of concurrent users with adaptive bitrate streaming and global content delivery.",
    videoUrl: "https://www.youtube.com/watch?v=example2",
    thumbnail: "/api/placeholder/400/225",
    difficulty: "advanced",
    estimatedTime: 60,
    tags: ["Video Streaming", "CDN", "Adaptive Bitrate", "Load Balancing", "Microservices"],
    steps: [
  ...
  },
  {
    ...
    description: "Design a search engine that can index billions of web pages and return relevant results in milliseconds.",
    ...
    relatedTopics: ["Search Algorithms", "Distributed Systems", "Information Retrieval"]
  },
  {
    id: "uber-matching",
    title: "Uber Driver-Rider Matching",
    description: "Design a real-time matching system that connects drivers with riders efficiently while considering location, availability, and preferences.",
    videoUrl: "https://www.youtube.com/watch?v=example4",
    thumbnail: "/api/placeholder/400/225",
    difficulty: "intermediate",
    estimatedTime: 40,
    tags: ["Real-time Matching", "Geolocation", "Load Balancing", "Microservices"],
    steps: [
  ...
  },
  {
    ...
    description: "Design a social media timeline that shows tweets from followed users in real-time with infinite scroll and engagement features.",
    videoUrl: "https://www.youtube.com/watch?v=example5",
    thumbnail: "/api/placeholder/400/225",
    difficulty: "intermediate",
    estimatedTime: 50,
    tags: ["Social Media", "Real-time", "Infinite Scroll", "Caching", "Database"],
    steps: [
...
export default function SystemDesignPage() {
  ...
  const allTags = Array.from(new Set(systemDesignFeatures.flatMap(feature => feature.tags)));
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-muted-foreground mb-8">
            Master frontend system design with real-world examples from YouTube tutorials
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <div className="bg-card rounded-lg shadow-sm border border-border p-6 text-center">
            <div className="text-3xl font-bold text-blue-600 mb-2">{systemDesignFeatures.length}</div>
            <div className="text-card-foreground font-medium">System Designs</div>
          </div>
          <div className="bg-card rounded-lg shadow-sm border border-border p-6 text-center">
            <div className="text-3xl font-bold text-green-600 mb-2">
              {systemDesignFeatures.reduce((sum, feature) => sum + feature.estimatedTime, 0)}
            </div>
            <div className="text-card-foreground font-medium">Total Minutes</div>
          </div>
          <div className="bg-card rounded-lg shadow-sm border border-border p-6 text-center">
          ...
          <div className="bg-card rounded-lg shadow-sm border border-border p-6 text-center">
            ...
            <div className="text-card-foreground font-medium">Topics Covered</div>
          </div>
        </div>
        ...
        <div className="bg-card rounded-lg shadow-sm border border-border p-6 mb-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
              <label htmlFor="difficulty" className="block text-sm font-medium text-card-foreground mb-2">
                Difficulty
              </label>
              <select
                id="difficulty"
            ...
            >
              ...
              <div className="flex justify-between items-start mb-4">
                ...
                <div className="flex items-center space-x-2">
                  <span className={`px-2 py-1 text-xs font-medium rounded-full ${getDifficultyColor(feature.difficulty)}`}>
                    {feature.difficulty}
                  </span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4 mb-4">
                <div className="text-sm">
                  ...
                  <span className="ml-1 font-medium">{feature.estimatedTime} min</span>
                </div>
                <div className="text-sm">
                  <span className="text-muted-foreground">📊 Steps:</span>
                  <span className="ml-1 font-medium">{feature.steps.length}</span>
                </div>
                <div className="text-sm">
                  <span className="text-muted-foreground">📐 Diagrams:</span>
                  <span className="ml-1 font-medium">{feature.diagrams.length}</span>
                </div>
                <div className="text-sm">
                  <span className="text-muted-foreground">💡 Concepts:</span>
                  <span className="ml-1 font-medium">{feature.keyConcepts.length}</span>
                </div>
              </div>

              {/* Key Concepts Preview */}
              <div className="mb-4">
                <h4 className="text-sm font-medium text-card-foreground mb-2">Key Concepts:</h4>
              ...
              <div className="flex justify-between items-center">
                <div className="flex space-x-2">
                  ...
                  <button className="px-4 py-2 border border-border text-foreground rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors text-sm">
                    View Details
                  </button>
                </div>
                {feature.isCompleted && (
        ...
        {filteredFeatures.length === 0 && (
          <div className="text-center py-12">
            ...
            <h3 className="text-xl font-semibold text-foreground mb-2">No system designs found</h3>
            <p className="text-muted-foreground mb-4">
        ...
        <div className="mt-16 text-center">
          <div className="bg-gradient-to-r from-purple-600 to-blue-600 rounded-lg p-8 text-white">
            ...
            <p className="text-xl mb-6 opacity-90">
              Start with these real-world examples and build your system design skills
            </p>
            <div className="flex justify-center space-x-4">
              <Link
                href="https://www.youtube.com/playlist?list=PLI9W87-Dqn7j_x6QtR6sUjycJR7nQLBqT"
              ...
              <Link
                ...
                className="border-2 border-white text-white px-6 py-3 rounded-md font-medium hover:bg-white hover:text-purple-600 transition-colors duration-200"
              >
                Advanced Topics
              </Link>
            </div>
