  ...
  const loadPlanAndSections = useCallback(async () => {
    try {
      ...
      if (sectionsData.success) {
        ...
        // If plan has sections, merge them with the loaded sections
        if (planData.success && planData.data.sections) {
          const planSections = planData.data.sections;
          const mergedSections = learningSections.map(section => {
            const planSection = planSections.find(
              (ps: { id: string; questions?: string[] }) => ps.id === section.id
            );
            return planSection
              ? { ...section, questions: planSection.questions || [] }
              : section;
          });
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
                ...
                {!selectedSection ? (
                  ...
                  <div className="text-center py-12">
                    ...
                    <p className="text-gray-600 dark:text-gray-400 mb-4">
                      This section doesn&apos;t have any questions assigned yet
                    </p>
                    <Button
      ...
      <SectionQuestionManager
        ...
        planId={planId}
        onUpdate={() => {
          // Reload questions for the selected section
          if (selectedSection) {
