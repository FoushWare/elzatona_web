export interface MultipleChoiceQuestion {
  ...
  explanation: string;
  category: 'css' | 'javascript' | 'html' | 'websockets' | 'react' | 'general' | 'git';
...
export const multipleChoiceQuestions: MultipleChoiceQuestion[] = [
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      "git stash temporarily saves uncommitted changes and reverts the working directory to a clean state. It is useful when you need to switch branches but are not ready to commit your current work.",
    category: "git",
    difficulty: "easy",
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      "Interactive rebase (git rebase -i) allows you to edit, reorder, squash, or split commits before applying them. It is useful for cleaning up commit history before merging a feature branch.",
    category: "git",
    difficulty: "hard",
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      "git cherry-pick applies a specific commit from one branch to another. It is useful when you want to bring a specific fix or feature from one branch to another without merging the entire branch.",
    category: "git",
    difficulty: "medium",
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      "Git submodules allow you to include one Git repository as a subdirectory of another. They are useful for including third-party libraries or shared components while maintaining separate version control.",
    category: "git",
    difficulty: "hard",
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      "git log --oneline shows a condensed one-line summary of each commit, including the abbreviated commit hash and commit message. It is useful for getting a quick overview of commit history.",
    category: "git",
    difficulty: "easy",
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      "git reflog is a log of all reference updates in the repository. It is useful for recovering lost commits or branches, as it shows the history of where HEAD has been, even after destructive operations.",
    category: "git",
    difficulty: "hard",
  ...
  },
  {
    ...
    options: [
      ...
      "Moves a file to a file to a different branch",
    ],
    correctAnswer: 0,
    explanation:
      "git blame shows who last modified each line of a file and when. It is useful for understanding the history of changes, identifying who introduced specific code, and understanding the context of modifications.",
    category: "git",
    difficulty: "medium",
  ...
  {
    id: "git-worktree-4",
    question: "What are the benefits of using Git worktrees in a development workflow?",
    options: [
