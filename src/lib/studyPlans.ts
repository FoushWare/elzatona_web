...
export const studyPlans: StudyPlan[] = [
  {
    ...
    description: "Fast-track your preparation with focused daily sessions covering all essential topics. Perfect for last-minute interview preparation.",
    duration: {
      weeks: 1,
      hoursPerWeek: 14,
      totalHours: 14
    ...
    topics: [
      {
        ...
        description: "Core JavaScript concepts including hoisting, closures, promises, and async/await",
        category: "javascript",
        difficulty: "medium",
        estimatedHours: 4,
        resources: [
      ...
      },
      {
        ...
        description: "Essential React concepts including hooks, state management, and component lifecycle",
        category: "react",
        difficulty: "medium",
        estimatedHours: 4,
        resources: [
    ...
    schedule: [
      {
        ...
        topics: ["JavaScript Fundamentals", "React Core Concepts", "CSS & Styling", "System Design Basics"],
        totalHours: 14,
        dailySchedule: [
          {
            day: 1,
  ...
  },
  {
    ...
    description: "Comprehensive preparation with a balanced approach to cover all essential topics thoroughly. Perfect for systematic learning.",
    duration: {
      weeks: 4,
      hoursPerWeek: 6,
      totalHours: 24
    ...
    topics: [
      {
        ...
        description: "Complete JavaScript mastery including ES6+, async programming, and advanced concepts",
        category: "javascript",
        difficulty: "medium",
        estimatedHours: 8,
        resources: [
      ...
      },
      {
        ...
        description: "Advanced React concepts including performance optimization and state management",
        category: "react",
        difficulty: "hard",
        estimatedHours: 8,
        resources: [
      ...
      },
      {
        id: "css-advanced",
        title: "Advanced CSS",
        description: "Advanced CSS techniques including animations, preprocessors, and architecture",
        category: "css",
        difficulty: "medium",
        estimatedHours: 4,
        resources: [
      ...
      },
      {
        ...
        description: "Intermediate system design concepts for frontend applications",
        category: "system-design",
        difficulty: "hard",
        estimatedHours: 4,
        resources: [
            ...
            tasks: [
              {
                ...
                description: "Learn about BEM, CSS modules, and styled-components",
                type: "reading",
                estimatedTime: 90
              }
            ]
  ...
  },
  {
    ...
    description: "Deep dive into all aspects of frontend development with expert-level preparation and mastery. Perfect for career advancement.",
    duration: {
      weeks: 12,
      hoursPerWeek: 3,
      totalHours: 36
    ...
    topics: [
      {
        ...
        description: "Complete JavaScript mastery including advanced patterns and performance optimization",
        category: "javascript",
        difficulty: "hard",
        estimatedHours: 12,
        resources: [
      ...
      },
      {
        ...
        description: "Expert-level React including advanced patterns and performance optimization",
        category: "react",
        difficulty: "hard",
        estimatedHours: 12,
        resources: [
      ...
      },
      {
        ...
        description: "Expert-level system design for complex frontend applications",
        category: "system-design",
        difficulty: "hard",
        estimatedHours: 8,
        resources: [
