...
export const greatFrontendQuestions: GreatFrontendQuestion[] = [
  // JavaScript Functions Category
  {
    ...
    difficulty: "medium",
    description: "Explain how hoisting works in JavaScript and how it affects variable and function declarations.",
  ...
  },
  {
    ...
    subcategory: "Core Concepts",
    difficulty: "hard",
    description: "Explain the 'this' keyword in JavaScript and how its context changes in different scenarios.",
  ...
  },
  {
    ...
    difficulty: "hard",
    description: "Explain what closures are in JavaScript and provide practical examples of their use.",
  ...
  },
  {
    ...
    difficulty: "hard",
    description: "Explain the prototypal inheritance model in JavaScript and how it differs from classical inheritance.",
  ...
  },
  {
    ...
    difficulty: "medium",
    description: "Explain event delegation and how it can be used to handle events efficiently.",
  ...
  },
  {
    ...
    difficulty: "medium",
    description: "Explain callback functions and their role in handling asynchronous operations in JavaScript.",
  ...
  },
  {
    ...
    difficulty: "easy",
    description: "Explain destructuring assignment syntax and how it can be used with objects and arrays.",
  ...
  },
  {
    ...
    difficulty: "medium",
    description: "Explain debouncing and throttling techniques and when to use each one.",
  ...
  // User Interface Coding Category
  {
    ...
    difficulty: "medium",
    description: "Explain the difference between coding a website to be responsive versus using a mobile-first strategy.",
  ...
  },
  {
    ...
    difficulty: "medium",
    description: "Are you familiar with styling SVG? Explain different approaches to styling SVG elements.",
  ...
  },
  {
    ...
    subcategory: "Performance",
    difficulty: "medium",
    description: "Explain CSS sprites and how you would implement them on a page or site.",
  ...
  },
  {
    ...
    difficulty: "hard",
    description: "What considerations are important when designing or developing for multilingual sites?",
  ...
  // Algorithmic Coding Category
  {
    ...
    difficulty: "medium",
    description: "Implement efficient array manipulation algorithms and explain their time complexity.",
  ...
  },
  {
    ...
    difficulty: "medium",
    description: "Implement string manipulation algorithms and explain their applications.",
    url: "https://www.greatfrontend.com/questions/formats/algo-coding",
  ...
  },
  {
    ...
    difficulty: "medium",
    description: "Implement and compare different sorting algorithms and their time complexities.",
    url: "https://www.greatfrontend.com/questions/formats/algo-coding",
  ...
  // System Design Category
  {
    ...
    subcategory: "Performance",
    difficulty: "hard",
    description: "Explain the concept of caching and how it can be used to improve performance.",
  ...
  },
  {
    ...
    difficulty: "medium",
    description: "Explain the concept of Content Security Policy (CSP) and how it enhances security.",
  ...
  },
  {
    ...
    subcategory: "Security",
    difficulty: "hard",
    description: "Explain the concept of Cross-Site Request Forgery (CSRF) and its mitigation techniques.",
  ...
  },
  {
    ...
    difficulty: "hard",
    description: "Explain server-side rendering of React applications and its benefits.",
  ...
  },
  {
    ...
    subcategory: "Rendering",
    difficulty: "medium",
    description: "Explain static generation of React applications and its benefits.",
  ...
  // Web APIs Category
  {
    ...
    subcategory: "Storage",
    difficulty: "easy",
    description: "Describe the difference between localStorage and sessionStorage.",
  ...
  },
  {
    ...
    difficulty: "hard",
    description: "Explain the concept of a microtask queue and how it relates to the event loop.",
  ...
  // Testing Category
  {
    ...
    difficulty: "medium",
    description: "Explain the concept of code coverage and how it can be used to assess test quality.",
  ...
  },
  {
    ...
    difficulty: "medium",
    description: "Explain the concept of error propagation in JavaScript and best practices.",
...
// Utility functions
export const getQuestionsByCategory = (category: string): GreatFrontendQuestion[] => {
  return greatFrontendQuestions.filter(q => q.category === category);
};

export const getQuestionsByDifficulty = (difficulty: 'easy' | 'medium' | 'hard'): GreatFrontendQuestion[] => {
  return greatFrontendQuestions.filter(q => q.difficulty === difficulty);
};

export const getQuestionsByCompany = (company: string): GreatFrontendQuestion[] => {
...
export const searchQuestions = (query: string): GreatFrontendQuestion[] => {
  ...
  return greatFrontendQuestions.filter(q => 
