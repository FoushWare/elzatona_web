...
function reducer(state, action) {
  switch (action.type) {
    ...
    correctAnswer: 'A',
    explanation:
      'useState is perfect for simple state management. useReducer is better when you have complex state logic that involves multiple sub-values or when the next state depends on the previous one.',
    difficulty: 'intermediate',
    category: 'react',
...
.container {
  ...
  gap: 20px;
    ...
    correctAnswer: 'A',
    explanation:
      'Flexbox is designed for one-dimensional layouts (either rows or columns). Grid is designed for two-dimensional layouts (rows and columns at the same time).',
    difficulty: 'intermediate',
    category: 'css',
...
export const generalFrontendPhase1Questions: InternalQuestion[] = [
  // Webpack & Tooling
  {
    ...
    correctAnswer: 'A',
    explanation:
      "Webpack is a module bundler. It takes multiple JavaScript files and bundles them into a single file, which is necessary because browsers used to require a <script> tag for each file. Webpack parses files based on imports/exports, bundles them together, and applies optimizations. It's used extensively for setting up projects and configuring builds.",
    difficulty: 'intermediate',
    category: 'javascript',
  ...
  },
  {
    ...
    correctAnswer: 'A',
    explanation:
      "Yes. Since Webpack v5, tree shaking is enabled by default. However, it only works with ES6 imports. If dependencies or code use require, Webpack can't tree shake them.",
    difficulty: 'intermediate',
    category: 'javascript',
  ...
  },
  {
    ...
    correctAnswer: 'A',
    explanation:
      'CSS-in-JS affects performance through: Reduced caching efficiency; CLS issues since CSS is applied later; Extra React components for styled elements deepen the component tree, affecting render performance. A hybrid approach (static CSS for layout + CSS-in-JS for dynamic parts) is often best.',
    difficulty: 'intermediate',
    category: 'css',
  ...
  },
  {
    ...
    correctAnswer: 'A',
    explanation:
      "It's used to trigger side effects (API calls, logging, localStorage updates) after rendering. Overusing it can cause unnecessary re-renders and performance issues.",
    difficulty: 'intermediate',
    category: 'react',
  ...
  },
  {
    ...
    correctAnswer: 'A',
    explanation:
      "Because useEffect expects a cleanup function, but async functions return a promise. React doesn't know how to handle that promise. Instead, you should define an inner async function and call it inside useEffect.",
    difficulty: 'intermediate',
    category: 'react',
  ...
  },
  {
    id: 'tsd-01-12',
    question:
      'How would you handle state if you had: backend data, authentication, and global user settings?',
    options: {
    ...
    correctAnswer: 'A',
    explanation:
      'Backend data → keep in local component state or lift state slightly if shared. Authentication → React Context (global availability). Global settings with complex transitions → use a reducer (e.g., useReducer or Redux).',
    difficulty: 'intermediate',
    category: 'react',
  ...
  },
  {
    ...
    correctAnswer: 'A',
    explanation:
      'Essential state is the minimal, independent state (e.g., cart items). Derived state can be computed from essential state (e.g., total price).',
    difficulty: 'intermediate',
    category: 'react',
  ...
  },
  {
    ...
    correctAnswer: 'A',
    explanation:
      "State changes cause all subscribed components to re-render. Solution: split into multiple contexts and keep state as close as possible to where it's used.",
    difficulty: 'intermediate',
    category: 'react',
  ...
  },
  {
    ...
    correctAnswer: 'A',
    explanation:
      "E2E tests catch feature issues but don't pinpoint root causes. Unit/integration tests help localize bugs faster. A balanced pyramid ensures both feature coverage and debuggability.",
    difficulty: 'intermediate',
    category: 'javascript',
  ...
  },
  {
    ...
    correctAnswer: 'A',
    explanation:
      'Code coverage measures how much code executes when tests run. For frontend, 60–70% is a healthy balance. 80–90%+ is often overkill. Backend can aim higher (80–95%).',
    difficulty: 'intermediate',
    category: 'javascript',
  ...
  },
  {
    ...
    correctAnswer: 'A',
    explanation:
      'Yes, in finance projects they enforced ~95%. This led to useless tests written only for coverage, showing that strict numbers can hurt productivity.',
    difficulty: 'intermediate',
    category: 'javascript',
  ...
  },
  {
    ...
    correctAnswer: 'A',
    explanation:
      'Causes include: Large JS bundles delaying rendering; No CDN, poor caching, or no compression; Large CSS blocking rendering.',
    difficulty: 'intermediate',
    category: 'javascript',
  ...
  },
  {
    ...
    correctAnswer: 'A',
    explanation:
      'Ensure CDN, caching, and compression. Analyze bundles to remove unused code. Apply code splitting (React.lazy, dynamic imports). Defer or async load non-critical JS.',
    difficulty: 'intermediate',
    category: 'javascript',
  ...
  },
  {
    ...
    correctAnswer: 'A',
    explanation:
      "If app speed or SEO is critical (e.g., e-commerce, news sites). SSR instantly delivers HTML, improving FCP. Not worth it for SaaS apps where SEO isn't critical, since SSR adds complexity.",
    difficulty: 'intermediate',
    category: 'javascript',
...
export const generalFrontendPhase2Questions: InternalQuestion[] = [
  // Browser Storage
  {
    id: 'tsd-02-1',
    question:
      'What is the difference between cookies, localStorage, and sessionStorage in the browser?',
    code: `// Cookie example
...
sessionStorage.setItem('formData', JSON.stringify({name: 'John', email: 'john@example.com'}));`,
  ...
  // Performance Optimization
  {
    id: 'tsd-02-2',
    question:
      'If you are setting up a new frontend application, what optimizations would you put in place to make it performant?',
...
/>`,
  ...
  // Image Optimization
  {
    id: 'tsd-02-3',
    question:
      'You are building a frontend app with very large images (e.g., eCommerce). How would you optimize them?',
...
.image-container {
  ...
  width: 100%;
    ...
    correctAnswer: 'B',
    explanation:
      'Serve images at the smallest needed dimensions. Use compression and remove metadata. Prefer WebP over PNG/JPEG for better performance. Host via a CDN. Use lazy loading or load on scroll. Always set width/height to avoid layout shifts. Use srcset to deliver device-appropriate image sizes.',
    difficulty: 'intermediate',
    category: 'javascript',
  ...
  // Code Quality
  {
    id: 'tsd-02-4',
    question:
      'How would you manage code quality in a large-scale frontend application?',
...
module.exports = {
  ...
  printWidth: 80
    ...
    correctAnswer: 'B',
    explanation:
      'Linting & Formatting → ESLint, Prettier, TS Lint. Testing → Unit tests + E2E tests. Dependency Scanning → Monitor vulnerabilities in node_modules. Accessibility (a11y) checks with linters. Performance monitoring → Lighthouse, Sentry for Core Web Vitals.',
    difficulty: 'intermediate',
    category: 'javascript',
  ...
  // Security
  {
    id: 'tsd-02-5',
    question:
      'What is an XSS (Cross-Site Scripting) attack and how do you prevent it?',
...
function SafeComponent({ userInput }) {
  return <div>{userInput}</div>; // React escapes by default
    ...
    correctAnswer: 'B',
    explanation:
      'Attack: Attacker injects malicious JavaScript into the app (e.g., via comments). When other users load it, it executes on their browser. Prevention: Sanitize inputs → Prevent script injection into the DB. Avoid rendering raw HTML/JS from user input (e.g., dangerouslySetInnerHTML in React).',
    difficulty: 'intermediate',
    category: 'javascript',
...
function ShellApp() {
  ...
  // Normal vs Dynamic Imports
  {
    id: 'tsd-03-3',
    question:
      'What is the difference between normal (static) imports and dynamic imports?',
    code: `// Normal (Static) Import
...
function App() {
  return (
    ...
    options: {
      A: 'Static imports are always faster than dynamic imports',
      B: 'Static imports are loaded at compile time and bundled together, while dynamic imports are loaded at runtime and enable code-splitting',
      C: 'Dynamic imports can only be used with React.lazy',
      D: 'Static imports cannot be tree-shaken by bundlers',
    },
    correctAnswer: 'B',
    explanation:
      "Normal (static) imports are loaded at compile time, bundled with the main JS bundle, cannot be conditional, and are synchronous. They're tree-shaking friendly as unused exports are removed by bundlers like Webpack or Vite. Dynamic imports are loaded at runtime, return a Promise, can be conditional, enable code-splitting, reduce initial bundle size, but have limited tree-shaking as bundlers usually include the entire module in a separate chunk. In React, commonly used with React.lazy + Suspense for component-level code splitting.",
    difficulty: 'advanced',
    category: 'javascript',
    tags: [
      'imports',
