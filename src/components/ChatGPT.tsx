...
export default function ChatGPT() {
  ...
  return (
    <>
      ...
      <button
        onClick={toggleChat}
        className="fixed bottom-3 right-3 sm:bottom-4 sm:right-4 md:bottom-4 md:right-4 lg:bottom-6 lg:right-6 z-50 w-12 h-12 sm:w-14 sm:h-14 md:w-14 md:h-14 lg:w-16 lg:h-16 bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 hover:from-blue-600 hover:via-purple-600 hover:to-pink-600 text-white rounded-full shadow-2xl hover:shadow-3xl transition-all duration-500 transform hover:scale-110 hover:rotate-3 flex items-center justify-center group"
      ...
      >
        ...
        <div className="relative z-10 flex items-center justify-center">
          <MessageCircle
            size={24}
            className="drop-shadow-lg sm:w-6 sm:h-6 md:w-6 md:h-6 lg:w-7 lg:h-7"
          />
        </div>

        {/* Floating notification dot */}
        <div
          className="absolute -top-1 -right-1 w-2 h-2 sm:w-3 sm:h-3 md:w-3 md:h-3 lg:w-4 lg:h-4 bg-red-500 rounded-full animate-bounce shadow-lg"
          role="status"
