...
export default function AdminNavbar() {
  ...
  const adminMenuItems = [
    ...
    },
    {
      ...
      icon: BookOpen,
      description: 'Manage learning path sections and questions',
    },
    {
      href: '/admin/content',
      label: 'Content Management',
      icon: FileText,
      description: 'Manage all website content and sections',
    },
    {
      href: '/admin/content/questions',
      label: 'Questions',
      icon: HelpCircle,
      description: 'Add, edit, and manage questions with audio',
    },
    {
      href: '/admin/users',
