...
| 4   | `/admin/content-management` | `src/app/admin/content-management/page.tsx`      | 3367  | In Progress | 16/16      | ❌       | 0%    | ❌        | **CRITICAL** | [content-management.md](admin/content-management.md) |
