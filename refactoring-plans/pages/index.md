...
| 4   | `/admin/content-management` | `apps/admin/pages/admin/content-management/page.tsx` | 266   | Done        | 16/16      | ✅       | 92%   | ✅        | **CRITICAL** | [content-management.md](admin/content-management.md) |
