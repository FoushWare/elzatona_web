...
| 4   | `/admin/content-management` | `src/app/Pages/admin/content-management/page.tsx` | 3367  | In Progress | 0/15       | ❌       | 0%    | ❌        | **CRITICAL** | [content-management.md](admin/content-management.md) |
...
| 4   | `/dashboard`                                | `src/app/Pages/dashboard/page.tsx`                                | -     | Done    | 0/5        | ❌       | 0%    | ❌        | High         | [dashboard.md](user/dashboard.md)                                 |
