...
## Integration Tests
- All repository methods (CRUD, query, progress, preferences) are covered by integration tests in libs/database/src/repositories/__tests__/
- All adapter methods are covered by unit and basic integration tests in libs/database/src/adapters/postgresql/__tests__/
...
### Test Setup
- Integration tests for repositories: libs/database/src/repositories/__tests__/
- Integration tests for adapters: libs/database/src/adapters/postgresql/__tests__/
