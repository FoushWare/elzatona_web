...
"test:auth": "../../apps/admin/Utils/scripts/run-auth-tests.sh",
...
"test:admin": "../../apps/admin/Utils/scripts/run-admin-tests.sh",
...
"test:theme": "../../apps/admin/Utils/scripts/run-theme-tests.sh",
...
"test:e2e:auto": "../../apps/admin/Utils/scripts/run-e2e-tests.sh all",
"test:e2e:auto:smoke": "../../apps/admin/Utils/scripts/run-e2e-tests.sh smoke",
"test:e2e:auto:mode-switcher": "../../apps/admin/Utils/scripts/run-e2e-tests.sh mode-switcher",
"test:e2e:auto:get-started": "../../apps/admin/Utils/scripts/run-e2e-tests.sh get-started",
