...
*Note: To enable real-time AI assistance, please configure your DeepSeek API key in .env.local and restart the server.*`,
              role: 'assistant',
            },
            finish_reason: 'stop',
          },
...
*Note: This is a fallback response while the AI service is temporarily unavailable. Please check your DeepSeek API configuration or try again later.*`,
              role: 'assistant',
            },
            finish_reason: 'stop',
          },
