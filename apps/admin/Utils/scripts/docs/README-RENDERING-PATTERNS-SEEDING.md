...
Located in `apps/admin/Utils/scripts/`:
...
2. Clear existing questions: `../../apps/admin/Utils/scripts/seed-rendering-patterns-questions.sh clear`
3. Re-seed: `../../apps/admin/Utils/scripts/seed-rendering-patterns-questions.sh seed-all`
