...
async function seedRenderingPatternsQuestions() {
  console.log('🚀 Starting Rendering Patterns questions seeding process...');
  ...
  console.log(`📁 Found ${files.length} Rendering Patterns question files`);
  ...
  console.log('\n🎉 Rendering Patterns questions seeding completed!');
  console.log('📊 Summary:');
...
seedRenderingPatternsQuestions()
  .then(() => {
    console.log(
      '✅ Rendering Patterns questions seeding process completed successfully'
    );
    process.exit(0);
  })
  .catch(error => {
    console.error(
      '❌ Rendering Patterns questions seeding process failed:',
      error
    );
    process.exit(1);
  });
