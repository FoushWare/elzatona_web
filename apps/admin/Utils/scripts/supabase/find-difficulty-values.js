...
/**
 * Find Correct Difficulty Values
 * Tests different difficulty values to find the correct ones
 */
...
async function testDifficultyValues() {
  console.log('🧪 Testing difficulty values...\n');
...
async function main() {
  console.log('🔍 Finding Correct Difficulty Values...\n');
