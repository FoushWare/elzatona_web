...
console.log(`   Is Production: ${isProductionEnvironment() ? '✅ YES' : '❌ NO'}`);
console.log(`   Is Development: ${isDevelopmentEnvironment() ? '✅ YES' : '❌ NO'}`);
console.log('');

console.log('🔗 Supabase Configuration:');
console.log(`   Project Reference: ${getSupabaseProjectRef() || 'Not found'}`);
console.log(`   URL: ${info.supabaseUrl || 'Not configured'}`);
console.log(`   Has Anon Key: ${config_data.supabaseAnonKey ? '✅ YES' : '❌ NO'}`);
console.log(`   Has Service Role Key: ${config_data.supabaseServiceRoleKey ? '✅ YES' : '❌ NO'}`);
console.log('');
...
console.log(`   Has Admin Password: ${config_data.adminPassword ? '✅ YES' : '❌ NO'}`);
console.log('');

console.log('🎛️  Feature Flags:');
console.log(`   Debug Logging: ${config_data.enableDebugLogging ? '✅ ENABLED' : '❌ DISABLED'}`);
console.log(`   Test Data: ${config_data.enableTestData ? '✅ ENABLED' : '❌ DISABLED'}`);
console.log('');
