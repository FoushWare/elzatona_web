...
export const parseAsString = jest.fn((defaultValue?: string) => defaultValue || '');
export const parseAsInteger = jest.fn((defaultValue?: number) => defaultValue || 0);
export const parseAsArrayOf = jest.fn(() => [null, jest.fn()]);
export const useQueryStates = jest.fn(() => [{} as Record<string, any>, jest.fn()]);
