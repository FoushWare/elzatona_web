...
export function QuestionForm({
  ...
  useEffect(() => {
    if (externalSubmitTrigger !== undefined && externalSubmitTrigger > 0 && !disabled) {
      let dataToSubmit: Partial<Question>;
    ...
    <form onSubmit={handleSubmit} className='space-y-6 p-4'>
      ...
      {isJsonMode ? (
        <div className='space-y-2'>
          ...
          <p className='text-xs text-gray-500 dark:text-gray-400'>
            Enter the complete question data as JSON. The JSON will be validated before submission.
          </p>
        </div>
      ) : (
        <>
        ...
        <div>
          ...
          <Select
            ...
            onValueChange={value =>
              handleSelectChange('learningCardId', value === 'none' ? '' : value)
            }
            disabled={disabled}
          >
            <SelectTrigger
            ...
            <SelectContent className='z-[110] max-h-[300px]'>
              ...
              {filteredCards.length === 0 ? (
                <SelectItem value='no-results' disabled>
                  {learningCardSearch ? 'No cards found' : 'Loading cards...'}
                </SelectItem>
              ) : (
      ...
      <Collapsible open={isContentOpen} onOpenChange={setIsContentOpen}>
        <CollapsibleTrigger className='flex items-center justify-between w-full py-3 px-4 rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors cursor-pointer'>
          <div className='flex items-center gap-2'>
            ...
            <Label htmlFor='content' className='text-base font-semibold cursor-pointer'>
        ...
        <CollapsibleContent className='pt-2 space-y-2'>
          ...
          />
          <p className='text-xs text-gray-500 dark:text-gray-400'>
            Provide the main question content or description that users will see.
          </p>
        </CollapsibleContent>
      </Collapsible>
      ...
      <div>
        ...
        <p className='text-xs text-gray-500 dark:text-gray-400 mt-1'>
          Code will be displayed as a formatted code block in question details. Supports syntax highlighting.
        </p>
      </div>
      ...
      <Collapsible open={isResourcesOpen} onOpenChange={setIsResourcesOpen}>
        <CollapsibleTrigger className='flex items-center justify-between w-full py-3 px-4 rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors cursor-pointer'>
          <div className='flex items-center gap-2'>
            ...
            <Label htmlFor='resources' className='text-base font-semibold cursor-pointer'>
              Learning Resources{' '}
              <span className='text-gray-500 dark:text-gray-400 text-xs font-normal'>
                (Optional)
              </span>
