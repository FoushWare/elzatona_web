...
export function LearningPlanCard({
  ...
  const planDifficulty = plan.difficulty.toLowerCase() as keyof typeof difficultyColors;
    ...
    >
      ...
      <div className="p-8">
        ...
        <div className="grid grid-cols-2 gap-4 mb-8">
          ...
          <div className="flex flex-col gap-1 p-3 bg-gray-50 dark:bg-gray-700/50 rounded-2xl border border-gray-100 dark:border-gray-700">
            <div className="flex items-center gap-2 text-purple-600 dark:text-purple-400">
              ...
              <span className="text-[10px] font-bold uppercase tracking-wider">Estimate</span>
            </div>
            <span className="text-sm font-bold text-gray-900 dark:text-white">
        ...
        {plan.outcomes && plan.outcomes.length > 0 && (
          <div className="mb-10">
            <p className="text-[10px] font-bold uppercase tracking-widest text-gray-400 mb-3">Core Outcomes</p>
            <div className="space-y-2">
              {plan.outcomes.slice(0, 2).map((outcome) => (
                <div key={outcome} className="flex items-center gap-2 text-xs text-gray-600 dark:text-gray-300 font-medium">
        ...
        >
          ...
          <span className="relative z-10">{isCompleted ? "Improve Results" : "Master This Path"}</span>
