...
export default function CodeEditor({
  ...
  useEffect(() => {
    const handleClickOutside = (event: MouseEvent) => {
      ...
      if (
        !target.closest(".theme-menu-container") &&
  ...
  return (
    <div className="flex flex-col gap-2 sm:gap-4 h-full">
              ...
              >
                {copied ? (
                  <>
                    ...
                    <span className="text-green-600 hidden xs:inline">
                      Copied!
                    </span>
                  </>
                ) : (
            ...
            <div className="relative theme-menu-container">
              ...
              >
                ...
                <span className="hidden sm:inline">
                  {availableThemes.find((t) => t.value === currentTheme)
                    ?.label || "Theme"}
                </span>
              </button>
              {showThemeMenu && (
            ...
            if (monaco) {
              ...
              if (typeof window !== "undefined") {
                ...
                if (!monacoEnv.baseUrl) {
                  ...
                  console.log(
                    "✅ Using bundled Monaco Editor (no CDN required)",
                  );
                }
              }
              ...
              const setupPrettierFormatter = async () => {
                try {
                  ...
                  if (
                    !prettierModule ||
                    !typescriptParserModule ||
                    !babelParserModule
                  ) {
                    console.warn(
                      "⚠️ Prettier standalone/parsers not available, using Monaco built-in formatter",
                    );
                    return;
                  }
                  ...
                  const typescriptParser =
                    typescriptParserModule.default || typescriptParserModule;
                  const babelParser =
                    babelParserModule.default || babelParserModule;
                  ...
                  console.log(
                    "✅ Prettier formatter configured for JavaScript and TypeScript",
                  );
                } catch (error) {
                  console.warn(
                    "⚠️ Could not load Prettier, using Monaco built-in formatter:",
                    error,
                  );
      ...
      {output && (
        <div
          ref={outputRef}
          className="mt-2 p-5 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900 rounded-xl border-2 border-gray-200 dark:border-gray-700 shadow-md"
        >
          ...
          {!output.stdout && !output.stderr && output.exitCode === 0 && (
            ...
            >
              <p className="text-sm text-gray-500 dark:text-gray-400 italic text-center">
                Code executed successfully but produced no output. Use
