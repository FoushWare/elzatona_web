...
export async function POST(
  ...
  try {
    ...
    return NextResponse.json(
      { success: false, error: error.message || 'Failed to add category to plan' },
      { status: 500 }
    );
  }
}
...
export async function GET(
  ...
  try {
    ...
    return NextResponse.json(
      { success: false, error: error.message || 'Failed to fetch plan categories' },
      { status: 500 }
    );
  }
}
...
export async function DELETE(
  ...
  try {
    ...
    return NextResponse.json(
      { success: false, error: error.message || 'Failed to remove category from plan' },
      { status: 500 }
    );
  }
}
