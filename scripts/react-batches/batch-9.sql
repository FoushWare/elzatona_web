...
('17c8582e-c8a6-46a7-a70b-92267085244d', 'What are the <Router> components of React Router v6?', 'React Router v6 provides four main `<Router>` components:
...
4. `<StaticRouter>`: For server-side rendering (SSR)', 'multiple-choice', 'intermediate', 4, '[{"id":"a","text":"`<BrowserRouter>`, `<HashRouter>`, `<MemoryRouter>`, `<StaticRouter>`","isCorrect":true},{"id":"b","text":"`<Router>`, `<Route>`, `<Link>`, `<NavLink>`","isCorrect":false},{"id":"c","text":"Only `<BrowserRouter>` exists in v6","isCorrect":false},{"id":"d","text":"`<Router>` is removed in v6","isCorrect":false}]', NULL, 'Each Router component creates a different type of history instance (browser, hash, memory, static) for different environments.', NULL, ARRAY[], ARRAY['react','react-router','router','v6','ssr','native'], '{"views":0,"attempts":0,"correct_attempts":0,"average_time":0}', '{"original_id":"react-q-081","original_type":"multiple-choice","topic":"React Router","sample_answers":[],"time_limit":120,"related_links":[],"created_by":"system","updated_by":"system","topic_id":null}', 'ca612436-af48-4e3f-a7fd-f9a9b2c52374', true, '2024-01-01T00:00:00.000Z', '2024-01-01T00:00:00.000Z'),
('52e00445-b7d6-4561-a764-df8d4273e6fb', 'What is the purpose of push and replace methods of history?', 'The `history` object has two navigation methods:
- `push()`: Adds a new entry to the browser history stack
- `replace()`: Replaces the current entry in the history stack

This affects browser back/forward behavior.', 'multiple-choice', 'intermediate', 3, '[{"id":"a","text":"`push()` replaces current URL; `replace()` adds to history","isCorrect":false},{"id":"b","text":"`push()` adds to history stack; `replace()` replaces current entry","isCorrect":true},{"id":"c","text":"Both behave identically","isCorrect":false},{"id":"d","text":"These methods are deprecated in v6","isCorrect":false}]', NULL, '`push()` adds to history (user can go back); `replace()` overwrites current history (no back to previous).', NULL, ARRAY[], ARRAY['react','react-router','history','navigation','browser-api'], '{"views":0,"attempts":0,"correct_attempts":0,"average_time":0}', '{"original_id":"react-q-082","original_type":"multiple-choice","topic":"React Router","sample_answers":[],"time_limit":120,"related_links":[],"created_by":"system","updated_by":"system","topic_id":null}', 'ca612436-af48-4e3f-a7fd-f9a9b2c52374', true, '2024-01-01T00:00:00.000Z', '2024-01-01T00:00:00.000Z'),
('975c5876-e327-4764-8995-40e8a040deca', 'How do you programmatically navigate using React Router v4?', 'In React Router v4, programmatic navigation can be done via:
...
Note: `URLSearchParams` requires a polyfill for IE11.', 'multiple-choice', 'intermediate', 3, '[{"id":"a","text":"`props.query`","isCorrect":false},{"id":"b","text":"Use `query-string` library or `URLSearchParams`","isCorrect":true},{"id":"c","text":"`useParams()` hook","isCorrect":false},{"id":"d","text":"Query params are not supported","isCorrect":false}]', NULL, 'React Router v4 delegates query parsing to userland libraries like `query-string` or native `URLSearchParams`.', NULL, ARRAY[], ARRAY['react','react-router','query-parameters','url-search-params','v4'], '{"views":0,"attempts":0,"correct_attempts":0,"average_time":0}', '{"original_id":"react-q-084","original_type":"multiple-choice","topic":"React Router","sample_answers":[],"time_limit":120,"related_links":[],"created_by":"system","updated_by":"system","topic_id":null}', 'ca612436-af48-4e3f-a7fd-f9a9b2c52374', true, '2024-01-01T00:00:00.000Z', '2024-01-01T00:00:00.000Z'),
('08f6d9ed-78cc-441d-a8ab-30bc94eace70', 'Why do you get a "Router may have only one child element" warning?', 'In React Router, `<Router>` expects a single child. To render multiple routes, wrap them in a `<Switch>` (v5) or use direct nesting (v6). The `<Switch>` renders only the first matching `<Route>`.
...
```', 'multiple-choice', 'intermediate', 3, '[{"id":"a","text":"You must always use `<Switch>`","isCorrect":false},{"id":"b","text":"`<Router>` requires a single child; use `<Switch>` to group routes","isCorrect":true},{"id":"c","text":"This warning is removed in v6","isCorrect":false},{"id":"d","text":"It’s caused by missing `exact` prop","isCorrect":false}]', NULL, 'The `<Router>` component requires exactly one child. Use `<Switch>` (v5) or direct route nesting (v6) to group multiple routes.', NULL, ARRAY[], ARRAY['react','react-router','switch','routing','error'], '{"views":0,"attempts":0,"correct_attempts":0,"average_time":0}', '{"original_id":"react-q-085","original_type":"multiple-choice","topic":"React Router","sample_answers":[],"time_limit":120,"related_links":[],"created_by":"system","updated_by":"system","topic_id":null}', 'ca612436-af48-4e3f-a7fd-f9a9b2c52374', true, '2024-01-01T00:00:00.000Z', '2024-01-01T00:00:00.000Z'),
('cdcd6466-29ab-4e95-b758-285b439fc2c4', 'How do you pass params to the history.push method in React Router v4?', 'When using `history.push()`, you can pass an object with `pathname`, `search` (query), and `state`:
```javascript
...
```', 'multiple-choice', 'intermediate', 4, '[{"id":"a","text":"`history.push(''/path'', { param: value })`","isCorrect":false},{"id":"b","text":"`history.push({ pathname: ''/path'', search: ''?q=1'', state: { data } })`","isCorrect":true},{"id":"c","text":"Only strings are allowed","isCorrect":false},{"id":"d","text":"Use URL fragments only","isCorrect":false}]', NULL, '`history.push()` accepts an object with `pathname`, `search` (for query params), and `state` (for transient data).', NULL, ARRAY[], ARRAY['react','react-router','history','navigation','state','query'], '{"views":0,"attempts":0,"correct_attempts":0,"average_time":0}', '{"original_id":"react-q-086","original_type":"multiple-choice","topic":"React Router","sample_answers":[],"time_limit":120,"related_links":[],"created_by":"system","updated_by":"system","topic_id":null}', 'ca612436-af48-4e3f-a7fd-f9a9b2c52374', true, '2024-01-01T00:00:00.000Z', '2024-01-01T00:00:00.000Z'),
('5692b41b-b7b0-4416-b8bf-891eb2484b9b', 'How do you implement a default or NotFound page?', 'In React Router, a `<Route>` without a `path` prop always matches. Place it last to catch unmatched routes:
```jsx
<Switch>
...
```', 'multiple-choice', 'intermediate', 3, '[{"id":"a","text":"Use `*` path: `<Route path=\"*\" component={NotFound} />`","isCorrect":false},{"id":"b","text":"Place a `<Route>` with no `path` prop last","isCorrect":true},{"id":"c","text":"It’s automatic in v6","isCorrect":false},{"id":"d","text":"Use `useRouteMatch()`","isCorrect":false}]', NULL, 'A `<Route>` with no `path` acts as a fallback and should be placed last to handle unmatched URLs.', NULL, ARRAY[], ARRAY['react','react-router','not-found','404','default-route'], '{"views":0,"attempts":0,"correct_attempts":0,"average_time":0}', '{"original_id":"react-q-087","original_type":"multiple-choice","topic":"React Router","sample_answers":[],"time_limit":120,"related_links":[],"created_by":"system","updated_by":"system","topic_id":null}', 'ca612436-af48-4e3f-a7fd-f9a9b2c52374', true, '2024-01-01T00:00:00.000Z', '2024-01-01T00:00:00.000Z'),
('a6991ca4-c4a6-4352-bdf2-a0972485c9d9', 'How do you get history in React Router v4?', 'To access the `history` object outside components in v4:
1. Create a `history.js` file with `createBrowserHistory()`
2. Use `<Router history={history}>` instead of `<BrowserRouter>`
3. Import `history` anywhere to call `history.push()`', 'multiple-choice', 'advanced', 5, '[{"id":"a","text":"Use `useHistory()` hook","isCorrect":false},{"id":"b","text":"Create a custom `history` instance and pass it to `<Router>`","isCorrect":true},{"id":"c","text":"`window.history` is sufficient","isCorrect":false},{"id":"d","text":"History is not accessible outside components","isCorrect":false}]', NULL, 'Creating a standalone `history` instance allows programmatic navigation from anywhere, not just components.', NULL, ARRAY[], ARRAY['react','react-router','history','custom-history','v4'], '{"views":0,"attempts":0,"correct_attempts":0,"average_time":0}', '{"original_id":"react-q-088","original_type":"multiple-choice","topic":"React Router","sample_answers":[],"time_limit":120,"related_links":[],"created_by":"system","updated_by":"system","topic_id":null}', 'ca612436-af48-4e3f-a7fd-f9a9b2c52374', true, '2024-01-01T00:00:00.000Z', '2024-01-01T00:00:00.000Z'),
('d8f7939a-42c5-4c4e-a6e0-2f71062431bb', 'How do you perform an automatic redirect after login?', 'Use React Router’s `<Redirect>` component to navigate after login:
```jsx
function Login() {
  if (isLoggedIn) {
