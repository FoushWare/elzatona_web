 ...
 * Uses the existing API endpoints to create questions instead of direct Firestore access
 */
...
// Question data for each category
...
async function createAllQuestions() {
  try {
    console.log('🚀 Starting question creation via API...');
