/**
 * Reset Password and Setup Admin Script
 * 
 * This script helps you reset the password and set up the admin role.
 * 
 * Usage: node tools/scripts/reset-password-and-setup-admin.js
 */
...
async function resetPasswordAndSetupAdmin() {
  console.log('🔥 Password Reset and Admin Setup Guide\n');
  ...
  await new Promise((resolve) => {
    rl.question('Press Enter after resetting the password...', () => {
      rl.close();
      resolve();
    });
  });

  console.log('\n🔧 STEP 2: Testing Login and Setting Up Admin Role');
