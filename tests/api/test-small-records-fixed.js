...
/**
 * Test Small Records with Correct Schema (Fixed)
  ...
  const questions = [
    {
      ...
      difficulty: 'beginner',
      points: 1,
      options: ['A library', 'A framework', 'A language', 'A database'], // PostgreSQL array format
      correct_answer: 'A library',
      explanation:
        'React is a JavaScript library for building user interfaces.',
      tags: ['react', 'frontend', 'javascript'], // PostgreSQL array format
      category_id: null,
...
async function main() {
  console.log('🧪 Testing Small Records with Correct Schema (Fixed)...\n');
