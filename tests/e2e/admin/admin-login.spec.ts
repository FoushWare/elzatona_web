...
test.describe('A-E2E-002: Admin Login Flow', () => {
  ...
  test('should show error message for invalid credentials', async ({ page }) => {
    ...
    const invalidEmail = process.env.TEST_INVALID_EMAIL || 'invalid-test@example.com';
    const invalidPassword = process.env.TEST_INVALID_PASSWORD || 'invalid-test-password-123';
  ...
  test('should show loading state during login submission', async ({ page }) => {
    ...
    const testEmail = process.env.TEST_INVALID_EMAIL || 'test-loading@example.com';
    const testPassword = process.env.TEST_INVALID_PASSWORD || 'test-loading-password-123';
  ...
  test('should handle network errors gracefully', async ({ page }) => {
    ...
    const testEmail = process.env.TEST_INVALID_EMAIL || 'test-network@example.com';
    const testPassword = process.env.TEST_INVALID_PASSWORD || 'test-network-password-123';
