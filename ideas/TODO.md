# Mobile Testing TODO List

## Interview Website Mobile Improvements

### 1. Resources Page Dark Mode Text Clarity
- [x] Fix text visibility in dark mode on resources page
- [x] Ensure proper contrast for readability
- [ ] **Note**: Linter errors need to be resolved (category property, apostrophe, any type)

### 2. Home Page Statistics Cards
- [x] Hide statistics cards by default on mobile
- [x] Add "Show Statistics" button to reveal cards
- [x] Add "Show Filters" button similar to Frontend page
...
- [x] Adjust or replace job filtering UI for mobile view
- [x] Ensure filters work well on small screens
- [x] Optimize segmented controls for mobile with toggle functionality

## Progress
- [x] Task 1: Resources page dark mode fix (COMPLETED - linter issues noted)
- [x] Task 2: Home page statistics toggle (COMPLETED)
- [x] Task 3: Apply pattern to all pages (COMPLETED)
