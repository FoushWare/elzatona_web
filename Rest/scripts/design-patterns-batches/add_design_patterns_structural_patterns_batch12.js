...
const newQuestions = [
  {
    ...
    "content": "What are the performance tradeoffs of using Proxy objects in large applications?",
...
console.log(`✅ Added ${newQuestions.length} questions for Structural Patterns (Batch 12)`);
