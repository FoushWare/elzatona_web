...
const newQuestions = [
  {
    ...
    "explanation": "The correct answer is: Too many or complex observers can cause performance issues during notifications",
    "points": 10,
    "options": [
      {
        "id": "a",
...
console.log(`✅ Added ${newQuestions.length} questions for Behavioral Patterns (Batch 6)`);
