...
const newQuestions = [
  ...
  },
  {
    ...
    "content": "In the example with <code>animalFunctionality</code> and <code>dogFunctionality</code>, why does Dog end up with both <code>bark()</code> and <code>walk()</code> methods?",
    "type": "multiple-choice",
    "category": "Design Patterns",
    "topic": "Structural Patterns",
    "difficulty": "intermediate",
    ...
    "explanation": "Because <code>Object.assign(dogFunctionality, animalFunctionality)</code> merged animal methods into dogFunctionality, then <code>Object.assign(Dog.prototype, dogFunctionality)</code> added all methods to Dog’s prototype. This effectively chained multiple mixins together.",
    "points": 10,
    "sampleAnswers": [
...
console.log(`✅ Added ${newQuestions.length} questions for Structural Patterns (Batch 4)`);
