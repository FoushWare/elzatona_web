...
const newQuestions = [
  {
    ...
    createdBy: 'admin',
    updatedBy: 'admin',
    tags: ['nextjs', 'incremental-static-regeneration', 'advanced'],
    explanation:
...
console.log(
  `✅ Added ${newQuestions.length} questions for Incremental Static Regeneration (Batch 1)`
);
