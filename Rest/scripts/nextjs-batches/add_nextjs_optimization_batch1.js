...
const newQuestions = [
  {
    ...
    createdBy: 'admin',
    updatedBy: 'admin',
    tags: ['nextjs', 'image-optimization', 'intermediate'],
    explanation:
...
console.log(
  `✅ Added ${newQuestions.length} questions for Optimization (Batch 1)`
);
