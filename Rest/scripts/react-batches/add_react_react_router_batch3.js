...
const newQuestions = [
  {
    ...
    explanation:
      "You have to wrap your Route's in a <code>&lt;Switch&gt;</code> block because <code>&lt;Switch&gt;</code> is unique in that it renders a route exclusively.",
    points: 15,
    options: [
      {
        id: 'o1',
  ...
  },
  {
    ...
    content:
      'How to pass params to <code>history.push</code> method in React Router v4?',
    type: 'multiple-choice',
    category: 'React',
    topic: 'React Router',
    difficulty: 'intermediate',
    ...
    tags: ['react', 'react-router', 'intermediate'],
    explanation:
      'While navigating you can pass props to the <code>history</code> object:',
    points: 15,
    options: [
      {
        id: 'o1',
  ...
  },
  {
    ...
    tags: ['react', 'react-router', 'intermediate'],
    explanation:
      'A <code>&lt;Switch&gt;</code> renders the first child <code>&lt;Route&gt;</code> that matches. A <code>&lt;Route&gt;</code> with no path always matches. So you just need to simply drop path attribute as below',
    points: 15,
    options: [
      {
        id: 'o1',
...
console.log(
  `✅ Added ${newQuestions.length} questions for React Router (Batch 3)`
);
