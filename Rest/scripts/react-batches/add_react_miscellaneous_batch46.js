...
const newQuestions = [
  {
    ...
    explanation:
      'You should initialize state in the constructor when using ES6 classes, and <code>getInitialState()</code> method when using <code>React.createClass()</code>.',
    points: 15,
    options: [
      {
        id: 'o1',
  ...
  },
  {
    ...
    tags: ['react', 'miscellaneous', 'intermediate'],
    explanation:
      "By default, when your component's state or props change, your component will re-render. If your <code>render()</code> method depends on some other data, you can tell React that the component needs re-rendering by calling <code>forceUpdate()</code>.",
    points: 15,
    options: [
      {
        id: 'o1',
  ...
  },
  {
    ...
    content:
      'What is the difference between <code>super()</code> and <code>super(props)</code> in React using ES6 classes?',
    type: 'multiple-choice',
    category: 'React',
    topic: 'Miscellaneous',
    difficulty: 'intermediate',
    ...
    tags: ['react', 'miscellaneous', 'intermediate'],
    explanation:
      'When you want to access <code>this.props</code> in <code>constructor()</code> then you should pass props to <code>super()</code> method.',
    points: 15,
    options: [
      {
        id: 'o1',
...
console.log(
  `✅ Added ${newQuestions.length} questions for Miscellaneous (Batch 46)`
);
