...
const newQuestions = [
  ...
  },
  {
    ...
    tags: ['react', 'core-react', 'intermediate'],
    explanation:
      'A <code>key</code> is a special attribute you **should** include when mapping over arrays to render data. _Key_ prop helps React identify which items have changed, are added, or are removed.',
    points: 15,
    options: [
      {
        id: 'o1',
...
console.log(
  `✅ Added ${newQuestions.length} questions for Core React (Batch 5)`
);
