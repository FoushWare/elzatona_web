...
const newQuestions = [
  {
    ...
    "explanation": "You can use **Context** in your application directly and is going to be great for passing down data to deeply nested components which what it was designed for.",
    "points": 15,
    "options": [
      {
        "id": "o1",
  ...
  },
  {
    ...
    "explanation": "You can use <code>redux-thunk</code> middleware which allows you to define async actions.",
    "points": 15,
    "options": [
      {
        "id": "o1",
        ...
        "isCorrect": true,
        "explanation": "You can use `redux-thunk` middleware which allows you to define async actions."
      },
      {
        "id": "o2",
        "text": "This is incorrect. Please refer to React documentation.",
...
console.log(`✅ Added ${newQuestions.length} questions for React Redux (Batch 4)`);
