...
const newQuestions = [
  ...
  },
  {
    ...
    tags: ['react', 'react-redux', 'intermediate'],
    explanation:
      'You need to write a _root reducer_ in your application which delegate handling the action to the reducer generated by <code>combineReducers()</code>.',
    points: 15,
    options: [
      {
        id: 'o1',
...
console.log(
  `✅ Added ${newQuestions.length} questions for React Redux (Batch 3)`
);
