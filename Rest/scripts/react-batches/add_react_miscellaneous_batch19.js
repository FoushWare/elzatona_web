...
const newQuestions = [
  {
    ...
    "explanation": "React includes a stable implementation of React Hooks in 16.8 release for below packages",
    "points": 15,
    "options": [
      {
        "id": "o1",
  ...
  },
  {
    ...
    "content": "Why do we use array destructuring (square brackets notation) in <code>useState</code>?",
    "type": "multiple-choice",
    "category": "React",
    "topic": "Miscellaneous",
    "difficulty": "intermediate",
    ...
    "explanation": "When we declare a state variable with <code>useState</code>, it returns a pair — an array with two items. The first item is the current value, and the second is a function that updates the value. Using [0] and [1] to access them is a bit confusing because they have a specific meaning. This is why we use array destructuring instead.",
    "points": 15,
    "options": [
      {
        "id": "o1",
  ...
  },
  {
    ...
    "explanation": "Hooks got the ideas from several different sources. Below are some of them,",
    "points": 15,
    "options": [
      {
        "id": "o1",
...
console.log(`✅ Added ${newQuestions.length} questions for Miscellaneous (Batch 19)`);
