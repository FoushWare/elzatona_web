...
const newQuestions = [
  ...
  },
  {
    ...
    tags: ['react', 'core-react', 'intermediate'],
    explanation:
      "A **controlled component** is a React component that **fully manages the form element's state**(e.g, elements like <code>&lt;input&gt;</code>, <code>&lt;textarea&gt;</code>, or <code>&lt;select&gt;</code>))  using React's internal state mechanism. i.e, The component does not manage its own internal state — instead, React acts as the single source of truth for form data.",
    points: 15,
    options: [
      {
        id: 'o1',
...
console.log(
  `✅ Added ${newQuestions.length} questions for Core React (Batch 7)`
);
