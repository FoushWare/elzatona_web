...
const newQuestions = [
  ...
  },
  {
    ...
    "explanation": "In React, the value attribute on form elements will override the value in the DOM. With an uncontrolled component, you might want React to specify the initial value, but leave subsequent updates uncontrolled. To handle this case, you can specify a **defaultValue** attribute instead of **value**.",
    "points": 15,
    "options": [
      {
        "id": "o1",
  ...
  },
  {
    ...
    "explanation": "Below are the main differences between Real DOM and Virtual DOM,",
    "points": 15,
    "options": [
      {
        "id": "o1",
...
console.log(`✅ Added ${newQuestions.length} questions for Miscellaneous (Batch 17)`);
