...
const newQuestions = [
  ...
  },
  {
    ...
    "explanation": "<code>redux-saga</code> is a library that aims to make side effects (asynchronous things like data fetching and impure things like accessing the browser cache) in React/Redux applications easier and better.",
    "points": 15,
    "options": [
      {
        "id": "o1",
        ...
        "isCorrect": true,
        "explanation": "`redux-saga` is a library that aims to make side effects (asynchronous things like data fetching and impure things like accessing the browser cache) in React/Redux applications easier and better."
      },
      {
        "id": "o2",
        "text": "This is incorrect. Please refer to React documentation.",
...
console.log(`✅ Added ${newQuestions.length} questions for React Redux (Batch 7)`);
