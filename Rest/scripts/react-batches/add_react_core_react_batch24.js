...
const newQuestions = [
  {
    ...
    explanation:
      "Yes, you can use <code>async/await</code> in plain React, as long as your JavaScript environment supports ES2017+. Nowadays most modern browsers and build tools support ES2017+ version. If you're using **Create React App**, **Next.js**, **Remix**, or any modern React setup, <code>async/await</code> is supported out of the box through **Babel**.",
    points: 15,
    options: [
      {
        id: 'o1',
...
console.log(
  `✅ Added ${newQuestions.length} questions for Core React (Batch 24)`
);
