...
const newQuestions = [
  ...
  },
  {
    ...
    tags: ['react', 'react-native', 'intermediate'],
    explanation:
      '_Flow_ is a _static type checker_ designed to find type errors in JavaScript. Flow types can express much more fine-grained distinctions than traditional type systems. For example, Flow helps you catch errors involving <code>null</code>, unlike most type systems.',
    points: 15,
    options: [
      {
        id: 'o1',
...
console.log(
  `✅ Added ${newQuestions.length} questions for React Native (Batch 2)`
);
