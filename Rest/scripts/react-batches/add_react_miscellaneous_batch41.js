...
const newQuestions = [
  {
    ...
    content: 'How are error boundaries handled in React v15?',
    ...
    explanation:
      'React v15 provided very basic support for _error boundaries_ using <code>unstable_handleError</code> method. It has been renamed to <code>componentDidCatch</code> in React v16.',
    points: 15,
    options: [
      {
        id: 'o1',
        text: 'React v15 provided very basic support for _error boundaries_ using `unstable_handleError` method',
        isCorrect: true,
        explanation:
  ...
  },
  {
    ...
    content: 'What is the purpose of render method of <code>react-dom</code>?',
    type: 'multiple-choice',
    category: 'React',
    topic: 'Miscellaneous',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    content:
      'What will happen if you use <code>setState()</code> in constructor?',
    type: 'multiple-choice',
    category: 'React',
    topic: 'Miscellaneous',
    difficulty: 'intermediate',
    ...
    tags: ['react', 'miscellaneous', 'intermediate'],
    explanation:
      'When you use <code>setState()</code>, then apart from assigning to the object state React also re-renders the component and all its children. You would get error like this: _Can only update a mounted or mounting component._ So we need to use <code>this.state</code> to initialize variables inside constructor.',
    points: 15,
    options: [
      {
        id: 'o1',
...
console.log(
  `✅ Added ${newQuestions.length} questions for Miscellaneous (Batch 41)`
);
