...
const newQuestions = [
  ...
  },
  {
    ...
    "explanation": "A _switching component_ is a component that renders one of many components. We need to use object to map prop values to components.",
    "points": 15,
    "options": [
      {
        "id": "o1",
...
console.log(`✅ Added ${newQuestions.length} questions for Core React (Batch 16)`);
