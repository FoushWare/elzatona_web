...
const newQuestions = [
  ...
  },
  {
    ...
    tags: ['react', 'miscellaneous', 'intermediate'],
    explanation:
      'Below are the <code>top 10 websites</code> using React as their front-end framework,',
    points: 15,
    options: [
      {
        id: 'o1',
...
console.log(
  `✅ Added ${newQuestions.length} questions for Miscellaneous (Batch 18)`
);
