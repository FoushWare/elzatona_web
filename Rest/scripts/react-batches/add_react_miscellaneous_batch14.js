...
const newQuestions = [
  {
    ...
    "explanation": "You can achieve code-splitting in your app using dynamic import.",
    "points": 15,
    "options": [
      {
        "id": "o1",
  ...
  },
  {
    ...
    "explanation": "React Suspense is a built-in feature that lets you defer rendering part of your component tree until some condition(asynchronous operation) is met—usually, data or code has finished loading. While waiting, Suspense lets you display a fallback UI like a spinner or placeholder.",
    "points": 15,
    "options": [
      {
        "id": "o1",
        "text": "React Suspense is a built-in feature that lets you defer rendering part of your component tree until some condition(asynchronous operation) is met—usu...",
        "isCorrect": true,
        "explanation": "React Suspense is a built-in feature that lets you defer rendering part of your component tree until some condition(asynchronous operation) is met—usually, data or code has finished loading. While waiting, Suspense lets you display a fallback UI like a spinner or placeholder."
      },
      {
...
console.log(`✅ Added ${newQuestions.length} questions for Miscellaneous (Batch 14)`);
