...
const newQuestions = [
  {
    id: 'react-ref-181',
    title: 'How do you say that props are readonly?',
    content: 'How do you say that props are readonly?',
  ...
  },
  {
    ...
    content: 'What are the conditions to safely use the index as a key?',
    type: 'multiple-choice',
    category: 'React',
    topic: 'Miscellaneous',
    difficulty: 'intermediate',
  ...
  {
    id: 'react-ref-183',
    title: 'Should keys be globally unique?',
    content: 'Should keys be globally unique?',
    type: 'multiple-choice',
    category: 'React',
    topic: 'Miscellaneous',
    difficulty: 'intermediate',
    ...
    options: [
      {
        id: 'o1',
        text: 'The keys used within arrays should be unique among their siblings but they don’t need to be globally unique',
        isCorrect: true,
        explanation:
          'The keys used within arrays should be unique among their siblings but they don’t need to be globally unique. i.e, You can use the same keys with two different arrays.',
      },
...
console.log(
  `✅ Added ${newQuestions.length} questions for Miscellaneous (Batch 12)`
);
