...
const newQuestions = [
  {
    ...
    "explanation": "You need to use <code>useEffect</code> hook to set focus on input field during page load time for functional component.",
    "points": 15,
    "options": [
      {
        "id": "o1",
        ...
        "isCorrect": true,
        "explanation": "You need to use `useEffect` hook to set focus on input field during page load time for functional component."
      },
      {
        "id": "o2",
  ...
  },
  {
    ...
    "explanation": "Add a listener on the <code>history</code> object to record each page view:",
    "points": 15,
    "options": [
      {
        "id": "o1",
...
console.log(`✅ Added ${newQuestions.length} questions for Core React (Batch 22)`);
