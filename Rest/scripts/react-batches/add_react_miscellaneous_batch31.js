...
const newQuestions = [
  {
    ...
    "explanation": "Keys are primarily used for rendering list items but they are not just for list items. You can also use them React to distinguish components. By default, React uses order of the components in",
    "points": 15,
    "options": [
      {
        "id": "o1",
  ...
  },
  {
    ...
    "explanation": "There are two guidelines to be taken care while writing reducers in your code.",
    "points": 15,
    "options": [
      {
        "id": "o1",
  ...
  },
  {
    ...
    "explanation": "You can efficiently build nextjs application if you are aware about which part of the application needs to use client components and which other parts needs to use server components. The common cases of both client and server components are listed below:",
    "points": 15,
    "options": [
      {
        "id": "o1",
...
console.log(`✅ Added ${newQuestions.length} questions for Miscellaneous (Batch 31)`);
