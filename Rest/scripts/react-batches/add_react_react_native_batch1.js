...
const newQuestions = [
  ...
  },
  {
    ...
    tags: ['react', 'react-native', 'intermediate'],
    explanation:
      'You can use <code>console.log</code>, <code>console.warn</code>, etc. As of React Native v0.29 you can simply run the following to see logs in the console:',
    points: 15,
    options: [
      {
        id: 'o1',
...
console.log(
  `✅ Added ${newQuestions.length} questions for React Native (Batch 1)`
);
