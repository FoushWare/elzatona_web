...
const newQuestions = [
  ...
  },
  {
    ...
    "explanation": "We can pass <code>numbers</code> as <code>props</code> to React component using curly braces <code>{}</code> where as <code>strings</code> in double quotes <code>\"\"</code> or single quotes <code>''</code>",
    "points": 15,
    "options": [
      {
        "id": "o1",
        ...
        "isCorrect": true,
        "explanation": "We can pass `numbers` as `props` to React component using curly braces `{}` where as `strings` in double quotes `\"\"` or single quotes `''`"
      },
      {
        "id": "o2",
        "text": "This is incorrect. Please refer to React documentation.",
  ...
  },
  {
    ...
    "content": "Do I need to keep all my state into Redux? Should I ever use react internal state?",
    "type": "multiple-choice",
    "category": "React",
    "topic": "Miscellaneous",
    "difficulty": "intermediate",
    ...
    "explanation": "It is up to the developer's decision, i.e., it is developer's job to determine what kinds of state make up your application, and where each piece of state should live. Some users prefer to keep every single piece of data in Redux, to maintain a fully serializable and controlled version of their application at all times. Others prefer to keep non-critical or UI state, such as “is this dropdown currently open”, inside a component's internal state.",
    "points": 15,
    "options": [
      {
        "id": "o1",
...
console.log(`✅ Added ${newQuestions.length} questions for Miscellaneous (Batch 3)`);
