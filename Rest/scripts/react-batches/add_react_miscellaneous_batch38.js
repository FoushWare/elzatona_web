...
const newQuestions = [
  {
    ...
    "explanation": "If you worked with React before, you might be familiar with an older API where the <code>ref</code> attribute is a string, like <code>ref={'textInput'}</code>, and the DOM node is accessed as <code>this.refs.textInput</code>. We advise against it because _string refs have below issues_, and are considered legacy. String refs were **removed in React v16**.",
    "points": 15,
    "options": [
      {
        "id": "o1",
...
console.log(`✅ Added ${newQuestions.length} questions for Miscellaneous (Batch 38)`);
