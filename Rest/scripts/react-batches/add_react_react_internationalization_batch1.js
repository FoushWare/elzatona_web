...
const newQuestions = [
  {
    ...
    "explanation": "The _React Intl_ library makes internationalization in React straightforward, with off-the-shelf components and an API that can handle everything from formatting strings, dates, and numbers, to pluralization. React Intl is part of _FormatJS_ which provides bindings to React via its components and API.",
    "points": 15,
    "options": [
      {
        "id": "o1",
  ...
  },
  {
    ...
    "explanation": "The library provides two ways to format strings, numbers, and dates:",
    "points": 15,
    "options": [
      {
        "id": "o1",
...
console.log(`✅ Added ${newQuestions.length} questions for React Internationalization (Batch 1)`);
