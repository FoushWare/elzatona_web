...
const newQuestions = [
  {
    ...
    "explanation": "React _does not_ apply _vendor prefixes_ automatically. You need to add vendor prefixes manually.",
    "points": 15,
    "options": [
      {
        "id": "o1",
  ...
  },
  {
    ...
    "explanation": "The component names should start with an uppercase letter but there are few exceptions to this convention. The lowercase tag names with a dot (property accessors) are still considered as valid component names.",
    "points": 15,
    "options": [
      {
        "id": "o1",
...
console.log(`✅ Added ${newQuestions.length} questions for Core React (Batch 23)`);
