...
const newQuestions = [
  {
    ...
    createdBy: 'admin',
    updatedBy: 'admin',
    tags: ['react', 'react-testing', 'intermediate'],
    explanation:
      "_Jest_ is a JavaScript unit testing framework created by Facebook based on Jasmine and provides automated mock creation and a <code>jsdom</code> environment. It's often used for testing components.",
    points: 15,
    options: [
      {
        id: 'o1',
  ...
  },
  {
    ...
    tags: ['react', 'react-testing', 'intermediate'],
    explanation:
      "Let's write a test for a function that adds two numbers in <code>sum.js</code> file:",
    points: 15,
    options: [
      {
        id: 'o1',
...
console.log(
  `✅ Added ${newQuestions.length} questions for React Testing (Batch 2)`
);
