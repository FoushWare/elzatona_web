...
const newQuestions = [
  {
    ...
    "content": "What is the purpose of <code>push()</code> and <code>replace()</code> methods of <code>history</code>?",
  ...
  },
  {
    ...
    "explanation": "There are three different ways to achieve programmatic routing/navigation within components.",
    "points": 15,
    "options": [
      {
        "id": "o1",
...
console.log(`✅ Added ${newQuestions.length} questions for React Router (Batch 2)`);
