...
const newQuestions = [
  {
    ...
    content:
      'What are the differences between <code>call()</code> and <code>put()</code> in redux-saga?',
    ...
    explanation:
      'Both <code>call()</code> and <code>put()</code> are effect creator functions. <code>call()</code> function is used to create effect description, which instructs middleware to call the promise. <code>put()</code> function creates an effect, which instructs middleware to dispatch an action to the store.',
    points: 15,
    options: [
      {
        id: 'o1',
  ...
  },
  {
    ...
    content:
      'What are the differences between <code>redux-saga</code> and <code>redux-thunk</code>?',
    type: 'multiple-choice',
    category: 'React',
    topic: 'React Redux',
    difficulty: 'intermediate',
...
console.log(
  `✅ Added ${newQuestions.length} questions for React Redux (Batch 8)`
);
