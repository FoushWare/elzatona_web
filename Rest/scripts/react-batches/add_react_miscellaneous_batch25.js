...
const newQuestions = [
  ...
  },
  {
    ...
    tags: ['react', 'miscellaneous', 'intermediate'],
    explanation:
      'StrictMode renders components twice in development mode(not production) in order to detect any problems with your code and warn you about those problems. This is used to detect accidental side effects in the render phase. If you used <code>create-react-app</code> development tool then it automatically enables StrictMode by default.',
    points: 15,
    options: [
      {
        id: 'o1',
...
console.log(
  `✅ Added ${newQuestions.length} questions for Miscellaneous (Batch 25)`
);
