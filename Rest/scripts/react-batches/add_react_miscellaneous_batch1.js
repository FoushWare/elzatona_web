...
const newQuestions = [
  {
    ...
    "content": "What are the main features of Reselect library?",
    ...
    "explanation": "Let's see the main features of Reselect library,",
    "points": 15,
    "options": [
      {
        "id": "o1",
        "text": "Let's see the main features of Reselect library,",
        "isCorrect": true,
        "explanation": "Let's see the main features of Reselect library,"
      },
      {
  ...
  },
  {
    ...
    "content": "Can Redux only be used with React?",
    "type": "multiple-choice",
    "category": "React",
    "topic": "Miscellaneous",
    "difficulty": "intermediate",
  ...
  },
  {
    ...
    "content": "Do you need to have a particular build tool to use Redux?",
    "type": "multiple-choice",
    "category": "React",
    "topic": "Miscellaneous",
    "difficulty": "intermediate",
...
console.log(`✅ Added ${newQuestions.length} questions for Miscellaneous (Batch 1)`);
