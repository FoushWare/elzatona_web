...
const newQuestions = [
  {
    ...
    "explanation": "Lets create <code>&lt;Title&gt;</code> and <code>&lt;Wrapper&gt;</code> components with specific styles for each.",
    "points": 15,
    "options": [
      {
        "id": "o1",
        ...
        "isCorrect": true,
        "explanation": "Lets create `<Title>` and `<Wrapper>` components with specific styles for each."
      },
      {
        "id": "o2",
...
console.log(`✅ Added ${newQuestions.length} questions for React Native (Batch 6)`);
