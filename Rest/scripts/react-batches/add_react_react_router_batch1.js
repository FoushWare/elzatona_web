...
const newQuestions = [
  {
    ...
    "explanation": "React Router is a powerful routing library built on top of React that helps you add new screens and flows to your application incredibly quickly, all while keeping the URL in sync with what's being displayed on the page.",
    "points": 15,
    "options": [
      {
        "id": "o1",
  ...
  },
  {
    ...
    "content": "What are the <code>&lt;Router&gt;</code> components of React Router v6?",
    "type": "multiple-choice",
    "category": "React",
    "topic": "React Router",
    "difficulty": "intermediate",
    ...
    "explanation": "React Router v6 provides below 4 <code>&lt;Router&gt;</code> components:",
    "points": 15,
    "options": [
      {
        "id": "o1",
...
console.log(`✅ Added ${newQuestions.length} questions for React Router (Batch 1)`);
