...
const newQuestions = [
  ...
  },
  {
    ...
    tags: ['react', 'react-native', 'intermediate'],
    explanation:
      "When the page loads, _React DevTools_ sets a global named <code>__REACT_DEVTOOLS_GLOBAL_HOOK__</code>, then React communicates with that hook during initialization. If the website is not using React or if React fails to communicate with DevTools then it won't show up the tab.",
    points: 15,
    options: [
      {
        id: 'o1',
  ...
  },
  {
    ...
    tags: ['react', 'react-native', 'intermediate'],
    explanation:
      '<code>styled-components</code> is a JavaScript library for styling React applications. It removes the mapping between styles and components, and lets you write actual CSS augmented with JavaScript.',
    points: 15,
    options: [
      {
        id: 'o1',
...
console.log(
  `✅ Added ${newQuestions.length} questions for React Native (Batch 5)`
);
