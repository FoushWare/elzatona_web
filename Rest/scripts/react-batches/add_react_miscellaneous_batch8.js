...
const newQuestions = [
  {
    ...
    options: [
      {
        id: 'o1',
        text: 'Apart from error messages and javascript stack, React16 will display the component stack trace with file names and line numbers using error boundary c...',
        isCorrect: true,
        explanation:
          'Apart from error messages and javascript stack, React16 will display the component stack trace with file names and line numbers using error boundary concept.',
      },
  ...
  },
  {
    ...
    content: 'What are default props?',
    type: 'multiple-choice',
    category: 'React',
    topic: 'Miscellaneous',
    difficulty: 'intermediate',
    ...
    tags: ['react', 'miscellaneous', 'intermediate'],
    explanation:
      "The _defaultProps_ can be defined as a property on the component to set the default values for the props. These default props are used when props not supplied(i.e., undefined props), but not for <code>null</code> or <code>0</code> as props. That means, If you provide null value then it remains null value. It's the same behavior with 0 as well.",
    points: 15,
    options: [
      {
        id: 'o1',
        text: 'The _defaultProps_ can be defined as a property on the component to set the default values for the props',
        isCorrect: true,
        explanation:
  ...
  },
  {
    ...
    content: 'What is the purpose of displayName class property?',
    type: 'multiple-choice',
    category: 'React',
    topic: 'Miscellaneous',
    difficulty: 'intermediate',
...
console.log(
  `✅ Added ${newQuestions.length} questions for Miscellaneous (Batch 8)`
);
