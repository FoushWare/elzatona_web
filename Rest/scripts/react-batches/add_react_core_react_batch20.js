...
const newQuestions = [
  ...
  },
  {
    ...
    tags: ['react', 'core-react', 'intermediate'],
    explanation:
      'If you try to render a <code>&lt;label&gt;</code> element bound to a text input using the standard <code>for</code> attribute, then it produces HTML missing that attribute and prints a warning to the console.',
    points: 15,
    options: [
      {
        id: 'o1',
...
console.log(
  `✅ Added ${newQuestions.length} questions for Core React (Batch 20)`
);
