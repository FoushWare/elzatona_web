...
const newQuestions = [
  {
    ...
    "content": "How to set initial state in Redux?",
  ...
  },
  {
    ...
    "content": "How Relay is different from Redux?",
    "type": "multiple-choice",
    "category": "React",
    "topic": "React Redux",
    "difficulty": "intermediate",
  ...
  },
  {
    ...
    "content": "What is an action in Redux?",
    "type": "multiple-choice",
    "category": "React",
    "topic": "React Redux",
    "difficulty": "intermediate",
    ...
    "explanation": "_Actions_ are plain JavaScript objects or payloads of information that send data from your application to your store. They are the only source of information for the store. Actions must have a type property that indicates the type of action being performed.",
    "points": 15,
    "options": [
      {
        "id": "o1",
        "text": "_Actions_ are plain JavaScript objects or payloads of information that send data from your application to your store",
        "isCorrect": true,
        "explanation": "_Actions_ are plain JavaScript objects or payloads of information that send data from your application to your store. They are the only source of information for the store. Actions must have a type property that indicates the type of action being performed."
      },
      {
...
console.log(`✅ Added ${newQuestions.length} questions for React Redux (Batch 11)`);
