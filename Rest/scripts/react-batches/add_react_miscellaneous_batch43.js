...
const newQuestions = [
  {
    ...
    "explanation": "The <code>create-react-app</code> CLI tool allows you to quickly create & run React applications with no configuration step.",
    "points": 15,
    "options": [
      {
        "id": "o1",
        ...
        "isCorrect": true,
        "explanation": "The `create-react-app` CLI tool allows you to quickly create & run React applications with no configuration step."
      },
      {
        "id": "o2",
  ...
  },
  {
    ...
    "explanation": "The lifecycle methods are called in the following order when an instance of a component is being created and inserted into the DOM.",
    "points": 15,
    "options": [
      {
        "id": "o1",
  ...
  },
  {
    ...
    "content": "What are the lifecycle methods going to be deprecated in React v16?",
    "type": "multiple-choice",
    "category": "React",
    "topic": "Miscellaneous",
    "difficulty": "intermediate",
    ...
    "explanation": "The following lifecycle methods going to be unsafe coding practices and will be more problematic with async rendering.",
    "points": 15,
    "options": [
      {
        "id": "o1",
...
console.log(`✅ Added ${newQuestions.length} questions for Miscellaneous (Batch 43)`);
