...
const newQuestions = [
  createQuestion(
    ...
    [
      {
        id: 'o1',
        text: 'Mixins: generate CSS blocks; Functions: return values for calculations',
        isCorrect: true,
      ...
      {
        id: 'o3',
        text: 'Functions generate CSS',
        isCorrect: false,
        explanation: 'Incorrect. Functions return values, not CSS.',
      },
      {
        id: 'o4',
        text: 'Mixins are deprecated',
        isCorrect: false,
        explanation: 'Incorrect. Mixins are still widely used.',
      },
    ]
  ),
  createQuestion(
    ...
    [
      {
        ...
        isCorrect: true,
        explanation: 'Correct. autoprefixer is essential.',
      },
      {
        id: 'o2',
        text: 'cssnano (minification)',
        isCorrect: true,
        explanation: 'Correct. cssnano optimizes CSS.',
      },
      {
        id: 'o3',
        text: 'postcss-preset-env (modern CSS)',
        isCorrect: true,
        explanation: 'Correct. Enables modern CSS features.',
      },
      {
        id: 'o4',
        text: 'jQuery (not a PostCSS plugin)',
        isCorrect: false,
        explanation: 'Incorrect. jQuery is a JavaScript library.',
      },
    ]
  ),
  createQuestion(
    ...
    [
      {
        id: 'o1',
        text: 'Shares styles between selectors; can create large selector groups; use mixins for better control',
        isCorrect: true,
        explanation: 'Correct. @extend has trade-offs.',
      },
      {
        id: 'o2',
        text: 'Always better than mixins',
        isCorrect: false,
        explanation: 'Incorrect. Mixins often provide better control.',
      },
      {
        id: 'o3',
        text: 'Only works with JavaScript',
        isCorrect: false,
        explanation: 'Incorrect. @extend is SASS feature.',
      },
      {
        id: 'o4',
        text: 'Is deprecated',
        isCorrect: false,
        explanation: 'Incorrect. @extend is still valid but use carefully.',
      },
    ]
  ),
];
...
console.log(
  `✅ Added ${newQuestions.length} Preprocessors questions (Batch 1)`
);
