...
console.log(`📝 Processing ${parsedQuestions.length} JavaScript questions in batches of 3...\n`);
...
for (let i = 0; i < parsedQuestions.length; i += batchSize) {
  ...
  console.log(`✅ Batch ${batchNum}: Added ${newQuestions.length} questions (${i + 1}-${Math.min(i + batchSize, parsedQuestions.length)})`);
}
