...
console.log('🌱 Seeding React Questions via Supabase MCP\n');
...
function generateBatchSQL(questions, batchSize = 10) {
  console.log(
...
async function main() {
  try {
    console.log('🚀 Starting React Questions Processing for MCP...\n');
    ...
    const sqlBatches = generateBatchSQL(mappedQuestions, 10);

    // Step 4: Save batches to files
    const batchesDir = path.join(process.cwd(), 'scripts', 'react-batches');
