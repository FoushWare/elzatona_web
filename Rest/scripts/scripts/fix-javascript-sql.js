...
const scriptsDir = path.join(__dirname, 'javascript-batches');
const batchFiles = fs
  .readdirSync(scriptsDir)
  .filter(file => file.startsWith('javascript-batch-') && file.endsWith('.sql'))
  .sort((a, b) => {
...
console.log('All JavaScript SQL batch files fixed!');
