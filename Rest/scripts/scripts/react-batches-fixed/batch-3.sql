...
('a9dde2d3-5c9a-4507-ae67-56ace01722b1', 'What are uncontrolled components?', 'The **Uncontrolled components** are form elements (like `<input>`, `<textarea>`, or `<select>`) that **manage their own state internally** via the **DOM**, rather than through React state.
...
('56ff2131-3fa1-4cc6-ad2a-83ebdfecf06d', 'What is the difference between createElement and cloneElement?', '#### **createElement:** 
...
('af8174d7-b301-49bc-b6c0-20285123b4d7', 'What is the children prop?', 'The `children` prop is a special prop in React used to pass elements between the opening and closing tags of a component. It is commonly used in layout and wrapper components.
...
('0c1771be-f222-47f7-bcdf-47b311796600', 'How to write comments in React?', 'The comments in React/JSX are similar to JavaScript Multiline comments but are wrapped in curly braces.
...
('3605c439-7a92-497d-9d32-3258cce42332', 'Does the lazy function support named exports?', 'No, currently `React.lazy` function supports default exports only. If you would like to import modules which are named exports, you can create an intermediate module that reexports it as the default. It also ensures that tree shaking keeps working and don''t pull unused components.
...
('a999d36b-3e7f-4f78-81cf-481338f1adb2', 'Why does React use className instead of the class attribute?', 'React uses **className** instead of **class** because of a JavaScript naming conflict with the class keyword.
