...
async function mapQuestionsToTopics(questions) {
  console.log('🔄 Mapping questions to topics and categories...\n');
...
async function main() {
  try {
    ...
    // Map questions to topics and categories
    const mappedQuestions = await mapQuestionsToTopics(allQuestions);
