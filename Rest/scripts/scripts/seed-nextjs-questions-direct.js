...
async function seedNextjsQuestions() {
  try {
    ...
    if (categoryError) {
      console.error('Error fetching Next.js category ID:', categoryError);
      return;
    }

    const categoryId = categoryData.id;
    console.log(`Found Next.js category ID: ${categoryId}`);
    ...
    console.log(`\n=== Next.js Seeding Complete ===`);
    console.log(`Total questions inserted: ${totalInserted}`);
    console.log(`Total errors: ${totalErrors}`);
  } catch (error) {
    console.error('Error in seedNextjsQuestions:', error);
  }
}
