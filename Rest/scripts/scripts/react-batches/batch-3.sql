...
```', 'multiple-choice', 'intermediate', 3, '[{"id":"a","text":"True","isCorrect":false},{"id":"b","text":"False","isCorrect":true}]', NULL, '`React.lazy` only supports default exports. To use named exports, you must re-export them as default in an intermediate file.', NULL, ARRAY[], ARRAY['react','lazy','code-splitting','dynamic-import','named-exports'], '{"views":0,"attempts":0,"correct_attempts":0,"average_time":0}', '{"original_id":"react-q-029","original_type":"true-false","topic":"Code Splitting","sample_answers":[],"time_limit":120,"related_links":[],"created_by":"system","updated_by":"system","topic_id":null}', 'ca612436-af48-4e3f-a7fd-f9a9b2c52374', true, '2024-01-01T00:00:00.000Z', '2024-01-01T00:00:00.000Z'),
('82195dcf-8cd7-4067-a856-19425d078ecb', 'Why does React use className instead of the class attribute?', 'React uses **className** instead of **class** because of a JavaScript naming conflict with the class keyword.
