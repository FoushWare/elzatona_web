...
const newQuestions = [
  {
    ...
    createdBy: 'admin',
    updatedBy: 'admin',
    tags: ['performance-patterns', 'tree-shaking', 'beginner', 'intermediate'],
    explanation:
    ...
    options: [
      {
        ...
        isCorrect: false,
        explanation:
          'Tree shaking only works reliably with ES2015 (ES6) modules using import/export syntax.',
      },
      {
        id: 'o2',
        text: 'False',
...
console.log(
  `✅ Added ${newQuestions.length} questions for Code Optimization (Batch 1)`
);
