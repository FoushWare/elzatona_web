...
const newQuestions = [
  {
    ...
    sampleAnswers: ['BrotliWebpackPlugin'],
    hints: [],
    metadata: {},
  },
  {
    ...
    createdBy: 'admin',
    updatedBy: 'admin',
    tags: ['performance-patterns', 'webpack-configuration', 'intermediate'],
    ...
    options: [
      {
        ...
        isCorrect: true,
        explanation:
          'Developers can define multiple entry points in Webpack to generate multiple bundles, allowing control over what loads initially versus later.',
      },
      {
        id: 'o2',
        text: 'False',
        isCorrect: false,
        explanation:
          'Webpack supports manual splitting via multiple entry points or dynamic imports.',
      },
      {
        id: 'o3',
...
console.log(
  `✅ Added ${newQuestions.length} questions for Webpack Configuration (Batch 1)`
);
