...
const newQuestions = [
  {
    ...
    createdBy: 'admin',
    updatedBy: 'admin',
    tags: ['performance-patterns', 'script-loading', null, 'intermediate'],
    explanation:
    ...
    sampleAnswers: ['After-Interactive'],
    hints: [],
    metadata: {},
  },
];
...
console.log(
  `✅ Added ${newQuestions.length} questions for Script Loading (Batch 1)`
);
