...
const newQuestions = [
  {
    ...
    createdBy: 'admin',
    updatedBy: 'admin',
    tags: ['performance-patterns', 'bundle-splitting', 'intermediate'],
    explanation:
    ...
    options: [
      {
        ...
        isCorrect: false,
        explanation:
          'The total code size remains the same; bundle splitting optimizes loading sequence, not total size.',
      },
      {
        id: 'o2',
        text: 'False',
...
console.log(
  `✅ Added ${newQuestions.length} questions for Code Splitting (Batch 1)`
);
