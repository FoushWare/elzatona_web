...
const newQuestions = [
  {
    ...
    createdBy: 'admin',
    updatedBy: 'admin',
    tags: ['performance-patterns', 'browser-apis', null, 'intermediate'],
    explanation:
    ...
    sampleAnswers: ['IntersectionObserver'],
    hints: [],
    metadata: {},
  },
];
...
console.log(
  `✅ Added ${newQuestions.length} questions for Browser APIs (Batch 1)`
);
