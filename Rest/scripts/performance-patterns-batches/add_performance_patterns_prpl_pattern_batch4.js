...
const newQuestions = [
    ...
    options: [
      {
        ...
        isCorrect: true,
        explanation:
          'Service Workers enable background caching and lazy-loading of routes and assets in PRPL.',
      },
      {
        id: 'o2',
        text: 'False',
        isCorrect: false,
        explanation:
          'PRPL relies heavily on Service Workers for offline caching and background resource fetching.',
      },
      {
        id: 'o3',
  ...
  },
  {
    ...
    createdBy: 'admin',
    updatedBy: 'admin',
    tags: ['performance-patterns', 'prpl-pattern', 'advanced'],
    explanation:
...
console.log(
  `✅ Added ${newQuestions.length} questions for PRPL Pattern (Batch 4)`
);
