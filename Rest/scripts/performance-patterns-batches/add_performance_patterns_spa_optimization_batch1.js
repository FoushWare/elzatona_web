...
const newQuestions = [
  {
    ...
    createdBy: 'admin',
    updatedBy: 'admin',
    tags: ['performance-patterns', 'spa-optimization', null, 'intermediate'],
    explanation:
      'Users experience faster initial render and smoother scrolling as code loads progressively.',
    points: 10,
    options: [],
    sampleAnswers: ['Smaller bundles and faster initial render.'],
    hints: [],
    metadata: {},
  },
  {
...
console.log(
  `✅ Added ${newQuestions.length} questions for SPA Optimization (Batch 1)`
);
