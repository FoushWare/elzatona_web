    ...
    options: [
      {
        ...
        isCorrect: false,
        explanation:
          'Virtualization renders only the visible items, not the entire list, to improve performance.',
      },
      {
        id: 'o2',
        text: 'False',
...
console.log(
  `✅ Added ${newQuestions.length} questions for Virtual Lists Rendering (Batch 1)`
);
