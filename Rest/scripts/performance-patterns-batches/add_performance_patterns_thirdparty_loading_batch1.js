...
const newQuestions = [
  {
    ...
    createdBy: 'admin',
    updatedBy: 'admin',
    tags: ['performance-patterns', 'third-party-loading', 'intermediate'],
    explanation:
    ...
    options: [
      {
        ...
        isCorrect: true,
        explanation:
          'Resource hints like dns-prefetch and preconnect reduce latency by initiating DNS lookups and TCP/TLS connections early.',
      },
      {
        id: 'o2',
        text: 'False',
        isCorrect: false,
        explanation:
          'Resource hints are effective and recommended for critical third-party resources.',
      },
      {
        id: 'o3',
...
console.log(
  `✅ Added ${newQuestions.length} questions for Third-Party Loading (Batch 1)`
);
