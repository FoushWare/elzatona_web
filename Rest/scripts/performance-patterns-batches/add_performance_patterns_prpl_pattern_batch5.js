    ...
    options: [
      {
        ...
        isCorrect: false,
        explanation:
          'While PWAs benefit most, PRPL can be used in any web app with modular architecture and caching.',
      },
      {
        id: 'o2',
        text: 'False',
...
console.log(
  `✅ Added ${newQuestions.length} questions for PRPL Pattern (Batch 5)`
);
