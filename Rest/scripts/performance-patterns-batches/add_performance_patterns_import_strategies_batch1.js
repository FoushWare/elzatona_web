...
const newQuestions = [
  {
    ...
    createdBy: 'admin',
    updatedBy: 'admin',
    tags: ['performance-patterns', 'import-strategies', null, 'intermediate'],
    explanation:
      'Import-on-visibility uses viewport detection rather than explicit user events to trigger the import.',
    points: 10,
    options: [],
    sampleAnswers: ['It loads on visibility, not just user click.'],
    hints: [],
    metadata: {},
  },
];
...
console.log(
  `✅ Added ${newQuestions.length} questions for Import Strategies (Batch 1)`
);
