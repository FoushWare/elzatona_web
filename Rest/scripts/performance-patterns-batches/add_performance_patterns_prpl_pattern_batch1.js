    ...
    options: [
      {
        ...
        isCorrect: true,
        explanation:
          'PRPL prioritizes loading and rendering the initial route first, then caching and lazy-loading the rest.',
      },
      {
        id: 'o2',
        text: 'False',
        isCorrect: false,
        explanation:
          'Other resources load only after the initial route completes.',
      },
      {
        id: 'o3',
...
console.log(
  `✅ Added ${newQuestions.length} questions for PRPL Pattern (Batch 1)`
);
