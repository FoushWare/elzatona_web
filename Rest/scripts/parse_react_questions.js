...
const referencePath = path.join(__dirname, '../final-questions-v01/react/reference.md');
const outputPath = path.join(__dirname, '../final-questions-v01/react-questions.json');
...
function parseQuestions() {
  ...
  sections.forEach((section, sectionIndex) => {
    ...
    if (sectionTitle.includes('Old Q&A') || sectionTitle.includes('Disclaimer')) {
      return;
    }
    ...
    while ((match = questionPattern.exec(section)) !== null) {
      ...
      const questionContent = section.substring(questionStart, questionEnd).trim();
      ...
      const question = {
        ...
        explanation: cleanedContent.substring(0, 500) + (cleanedContent.length > 500 ? '...' : ''),
        points: 15,
        options: [
          {
            id: 'o1',
            ...
            isCorrect: true,
            explanation: 'This is a conceptual question. Please refer to the explanation provided.'
          }
        ],
        hints: [
