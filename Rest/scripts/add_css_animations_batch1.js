...
const newQuestions = [
  createQuestion(
    ...
    15,
    [
      { id: "o1", text: "none: no styles; forwards: keeps final; backwards: applies first; both: forwards + backwards", isCorrect: true, explanation: "Correct. Each value controls different timing." },
      { id: "o2", text: "They are identical", isCorrect: false, explanation: "Incorrect. They behave differently." },
      { id: "o3", text: "Only 'forwards' works", isCorrect: false, explanation: "Incorrect. All values are valid." },
      { id: "o4", text: "Is deprecated", isCorrect: false, explanation: "Incorrect. fill-mode is a standard property." }
    ]
  ),
  createQuestion(
    ...
    "intermediate",
    ["css", "animations", "performance", "hardware-acceleration", "intermediate"],
    ...
    "multiple-select",
    [
      { id: "o1", text: "transform (translate, scale, rotate)", isCorrect: true, explanation: "Correct. transform triggers GPU acceleration." },
      { id: "o2", text: "opacity", isCorrect: true, explanation: "Correct. opacity triggers GPU acceleration." },
      { id: "o3", text: "filter", isCorrect: true, explanation: "Correct. filter triggers GPU acceleration." },
      { id: "o4", text: "width / height (not GPU accelerated)", isCorrect: false, explanation: "Incorrect. width/height trigger layout, not GPU." }
    ]
  ),
  createQuestion(
    ...
    20,
    [
      { id: "o1", text: "Hints browser for optimization; use only when animation starts, remove after; overuse causes memory issues", isCorrect: true, explanation: "Correct. will-change should be used judiciously." },
      { id: "o2", text: "Always use for all elements", isCorrect: false, explanation: "Incorrect. Overuse causes performance issues." },
      { id: "o3", text: "Only works with JavaScript", isCorrect: false, explanation: "Incorrect. will-change is pure CSS." },
