...
newQuestions.push(
  generateQuestion('ft-1',
    ...
    'Core React',
    [
      { text: 'Create reusable components (PostCard, CommentList, UserProfile) and compose them in a Dashboard container', isCorrect: true, explanation: 'Component composition promotes reusability and maintainability' },
  ...
  generateQuestion('ft-2',
    ...
    'Core React',
    [
      { text: 'Use Context API for global state (current video, user preferences) and useState for local component state', isCorrect: true, explanation: 'Context for shared state, useState for component-specific state' },
  ...
  generateQuestion('ft-3',
    ...
    'Core React',
    [
      { text: 'Use separate loading states for each data fetch, or use React Query/SWR for automatic loading state management', isCorrect: true, explanation: 'Granular loading states provide better UX, or use libraries that handle it automatically' },
...
const componentQuestions = [
  ...
  },
  {
    ...
    explanation: 'Lift state to common parent or use Context API. Props can\'t be passed directly between siblings.'
  }
];
...
console.log(`📝 To add all 30 questions, I need to expand the question templates`);
