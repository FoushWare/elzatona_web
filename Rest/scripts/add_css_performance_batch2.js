...
const getQuestionId = () =>
  `css-06-css${String(questionCounter++).padStart(2, '0')}`;
...
const newQuestions = [
  createQuestion(
    ...
    'intermediate',
    ['css', 'performance', 'critical-css', 'fcp', 'intermediate'],
    ...
    [
      {
        id: 'o1',
        text: 'Above-the-fold CSS; inline in <head>; improves FCP by reducing render-blocking',
        isCorrect: true,
        explanation: 'Correct. Critical CSS improves initial render.',
      },
      {
        id: 'o2',
        text: 'All CSS is critical',
        isCorrect: false,
        explanation: 'Incorrect. Only above-fold is critical.',
      },
      {
        id: 'o3',
        text: 'Slows down rendering',
        isCorrect: false,
        explanation: 'Incorrect. It speeds up initial render.',
      },
      {
        id: 'o4',
        text: 'Is deprecated',
        isCorrect: false,
        explanation: 'Incorrect. Critical CSS is best practice.',
      },
    ]
  ),
  createQuestion(
    ...
    'intermediate',
    ['css', 'performance', 'loading', 'strategies', 'intermediate'],
    ...
    [
      {
        id: 'o1',
        text: 'media attribute (conditional loading)',
        isCorrect: true,
        explanation: 'Correct. Enables conditional loading.',
      },
      {
        id: 'o2',
        text: 'preload (hint browser)',
        isCorrect: true,
        explanation: 'Correct. Improves resource hints.',
      },
      {
        id: 'o3',
        text: 'Critical CSS inline',
        isCorrect: true,
        explanation: 'Correct. Reduces render-blocking.',
      },
      {
        id: 'o4',
        text: 'Load all CSS synchronously (not optimal)',
        isCorrect: false,
        explanation: 'Incorrect. Synchronous loading blocks render.',
      },
    ]
  ),
  createQuestion(
    ...
    'difficult',
    ['css', 'performance', 'font-display', 'typography', 'difficult'],
    ...
    [
      {
        id: 'o1',
        text: 'Controls font loading: block/swap/fallback/optional; affects FOIT/FOUT and CLS',
        isCorrect: true,
        explanation: 'Correct. font-display controls loading behavior.',
      },
      {
        id: 'o2',
        text: 'Only affects visual appearance',
        isCorrect: false,
        explanation: 'Incorrect. It affects performance metrics.',
      },
      {
        id: 'o3',
        text: 'Slows down rendering',
        isCorrect: false,
        explanation: 'Incorrect. Proper use improves performance.',
      },
      {
        id: 'o4',
        text: 'Is deprecated',
        isCorrect: false,
        explanation: 'Incorrect. font-display is essential for performance.',
      },
    ]
  ),
];
