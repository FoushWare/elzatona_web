...
const newQuestions = [
  {
    ...
    "explanation": "HttpOnly restricts access to cookies from JavaScript, reducing XSS risks.",
    "points": 10,
    "options": [
      {
        "id": "o1",
...
console.log(`✅ Added ${newQuestions.length} questions for Session Management (Batch 4)`);
