...
const newQuestions = [
  {
    ...
    createdBy: 'admin',
    updatedBy: 'admin',
    tags: ['security', 'web-security-fundamentals', 'network', 'intermediate'],
    explanation:
  ...
  },
  {
    ...
    createdBy: 'admin',
    updatedBy: 'admin',
    tags: ['security', 'web-security-fundamentals', 'tokens', 'intermediate'],
    explanation:
...
console.log(
  `✅ Added ${newQuestions.length} questions for Web Security Fundamentals (Batch 8)`
);
