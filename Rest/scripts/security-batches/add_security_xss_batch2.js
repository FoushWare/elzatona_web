...
const newQuestions = [
    ...
    options: [
      {
        ...
        isCorrect: false,
        explanation:
          'HTTPS protects data in transit but does not prevent script injection on the client side.',
      },
      {
        id: 'o2',
        text: 'False',
  ...
  },
  {
    ...
    createdBy: 'admin',
    updatedBy: 'admin',
    tags: ['security', 'cross-site-scripting-xss', 'xss', 'advanced'],
    explanation:
    ...
    options: [
      {
        ...
        isCorrect: false,
        explanation:
          'DOM-based XSS occurs entirely on the client-side, manipulating the DOM with JavaScript.',
      },
      {
        id: 'o2',
        text: 'False',
