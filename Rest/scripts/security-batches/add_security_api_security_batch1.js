...
const newQuestions = [
  {
    ...
    createdBy: 'admin',
    updatedBy: 'admin',
    tags: ['security', 'api-security', 'rate limiting', 'intermediate'],
    explanation:
  ...
  },
  {
    ...
    createdBy: 'admin',
    updatedBy: 'admin',
    tags: ['security', 'api-security', 'api security', 'intermediate'],
    explanation:
...
console.log(
  `✅ Added ${newQuestions.length} questions for API Security (Batch 1)`
);
