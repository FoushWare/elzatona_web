    ...
    options: [
      {
        ...
        isCorrect: true,
        explanation:
          'HttpOnly prevents JavaScript access to cookies, mitigating XSS; Secure ensures cookies are only sent over HTTPS, mitigating MITM attacks.',
      },
      {
        id: 'o2',
        text: 'False',
...
console.log(
  `✅ Added ${newQuestions.length} questions for Session Management (Batch 2)`
);
