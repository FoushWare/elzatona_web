...
const newQuestions = [
  {
    ...
    createdBy: 'admin',
    updatedBy: 'admin',
    tags: ['security', 'web-security-fundamentals', 'headers', 'intermediate'],
    explanation:
  ...
  },
  {
    ...
    createdBy: 'admin',
    updatedBy: 'admin',
    tags: ['security', 'web-security-fundamentals', 'storage', 'intermediate'],
    explanation:
...
console.log(
  `✅ Added ${newQuestions.length} questions for Web Security Fundamentals (Batch 6)`
);
