...
const topicMap = {
  ...
  React: {
    'Core React': 'd9e02bfd-4293-42de-a9a8-65eeb7c61e32',
    Miscellaneous: 'f0d3f46a-4b24-4565-b20f-1fa1fd34639a',
  },
...
async function main() {
  ...
  console.log(
    'To execute, use mcp_supabase_execute_sql with project_id: kiycimlsatwfqxtfprlr\n'
  );
  ...
  const allSQL = sqlBatches
    .map(
      b =>
        `-- ${b.category} - Batch ${b.batchNum} (${b.count} questions)\n${b.sql}\n`
    )
    .join('\n');
