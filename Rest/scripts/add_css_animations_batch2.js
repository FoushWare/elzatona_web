...
const newQuestions = [
  createQuestion(
    ...
    15,
    [
      { id: "o1", text: "running: plays animation; paused: pauses animation; can be toggled dynamically", isCorrect: true, explanation: "Correct. play-state controls animation execution." },
      { id: "o2", text: "They are identical", isCorrect: false, explanation: "Incorrect. They control different states." },
      { id: "o3", text: "Only works with JavaScript", isCorrect: false, explanation: "Incorrect. Can be controlled with CSS." },
      { id: "o4", text: "Is deprecated", isCorrect: false, explanation: "Incorrect. play-state is a standard property." }
    ]
  ),
  createQuestion(
    ...
    15,
    [
      { id: "o1", text: "transition: simple state changes; animation: complex sequences with keyframes", isCorrect: true, explanation: "Correct. They serve different purposes." },
      { id: "o2", text: "They are identical", isCorrect: false, explanation: "Incorrect. They work differently." },
      { id: "o3", text: "animation is deprecated", isCorrect: false, explanation: "Incorrect. Both are valid and useful." },
      { id: "o4", text: "transition only works with JavaScript", isCorrect: false, explanation: "Incorrect. transition is pure CSS." }
    ]
  ),
  createQuestion(
    ...
    "difficult",
    ["css", "animations", "accessibility", "prefers-reduced-motion", "difficult"],
    ...
    20,
    [
      { id: "o1", text: "Use @media (prefers-reduced-motion: reduce) to disable/simplify animations; essential for accessibility", isCorrect: true, explanation: "Correct. Always respect motion preferences." },
      { id: "o2", text: "Animations ignore user preferences", isCorrect: false, explanation: "Incorrect. We should respect preferences." },
      { id: "o3", text: "Only works with JavaScript", isCorrect: false, explanation: "Incorrect. Can be handled with CSS media queries." },
      { id: "o4", text: "Is deprecated", isCorrect: false, explanation: "Incorrect. prefers-reduced-motion is essential for accessibility." }
    ]
  )
];
