...
function convertToMultipleChoice(question, explanation, sampleAnswers = []) {
  ...
  const keyPoints = cleanExplanation
    .split(/[.;]/)
  ...
  const options = [
    {
      id: 'o1',
      text:
        cleanExplanation.length > 200
          ? cleanExplanation.substring(0, 200) + '...'
          : cleanExplanation,
      isCorrect: true,
    ...
    },
    {
      ...
      text:
        keyPoints[0] ||
        'This approach focuses on scalability and performance optimization.',
      isCorrect: false,
      explanation: '',
    },
    {
      ...
      text:
        keyPoints[1] ||
        'This method prioritizes user experience and maintainability.',
      isCorrect: false,
      explanation: '',
    },
    {
...
sourceQuestions.forEach((q, index) => {
  ...
  if (q.type === 'multiple-choice' && q.options && q.options.length > 0) {
    ...
    const processed = {
      ...
      difficulty:
        q.difficulty === 'beginner'
          ? 'intermediate'
          : q.difficulty || 'intermediate', // Upgrade beginner to intermediate for senior level
    ...
    questionNum++;
    const options = convertToMultipleChoice(
      q.title,
      q.explanation || '',
      q.sampleAnswers || []
    );
...
console.log(
  '📝 Generating additional senior-level frontend system design questions...\n'
);
