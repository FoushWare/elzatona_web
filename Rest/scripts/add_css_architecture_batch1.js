...
const newQuestions = [
  createQuestion(
    ...
    [
      {
        id: 'o1',
        text: 'Layers: Settings → Tools → Generic → Elements → Objects → Components → Utilities; organizes by specificity',
        isCorrect: true,
        explanation: 'Correct. ITCSS uses layered architecture.',
      },
      {
        id: 'o2',
        text: 'Only one layer',
        isCorrect: false,
        explanation: 'Incorrect. ITCSS has multiple layers.',
      },
      {
        id: 'o3',
        text: 'Utilities come first',
        isCorrect: false,
        explanation: 'Incorrect. Utilities are at the top.',
      },
      {
        id: 'o4',
        text: 'Is deprecated',
        isCorrect: false,
        explanation: 'Incorrect. ITCSS is still used.',
      },
    ]
  ),
  createQuestion(
    ...
    [
      {
        ...
        isCorrect: true,
        explanation: 'Correct. BEM is component-based.',
      },
      {
        id: 'o2',
        text: 'CSS Modules',
        isCorrect: true,
        explanation: 'Correct. CSS Modules are component-scoped.',
      },
      {
        id: 'o3',
        text: 'OOCSS (object-oriented, not necessarily component-based)',
        isCorrect: false,
        explanation: 'Incorrect. OOCSS focuses on objects, not components.',
      },
      {
        id: 'o4',
        text: 'Utility-first (not component-based)',
        isCorrect: false,
        explanation: 'Incorrect. Utility-first is different approach.',
      },
    ]
  ),
  createQuestion(
    ...
    [
      {
        id: 'o1',
        text: 'Standardized design values; single source of truth; enables theming and consistency',
        isCorrect: true,
        explanation: 'Correct. Design tokens improve maintainability.',
      },
      {
        id: 'o2',
        text: 'Only for colors',
        isCorrect: false,
        explanation: 'Incorrect. Tokens can be any design value.',
      },
      {
        id: 'o3',
        text: 'Require JavaScript',
        isCorrect: false,
        explanation: 'Incorrect. CSS custom properties work without JS.',
      },
      {
        id: 'o4',
        text: 'Are deprecated',
