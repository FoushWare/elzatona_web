...
const jsTopicDescriptions = {
  ...
  'ES6+ Features':
    'Modern JavaScript features: destructuring, spread/rest operators, template literals, default parameters, and enhanced object literals',
  Prototypes:
    'JavaScript prototype system: prototype chain, __proto__, Object.create, prototype inheritance, and prototype methods',
  Generators:
    'Generator functions: yield keyword, generator objects, iterators, async generators, and use cases for lazy evaluation',
  'Async/Await':
    'Asynchronous JavaScript: Promises, async/await syntax, Promise methods (all, race, allSettled), error handling, and event loop',
  Modules:
    'ES6 modules: import/export syntax, default exports, named exports, dynamic imports, module scope, and module systems',
};
...
if (topics.categories.JavaScript && topics.categories.JavaScript.topics) {
  Object.keys(topics.categories.JavaScript.topics).forEach(topicName => {
    if (jsTopicDescriptions[topicName]) {
      topics.categories.JavaScript.topics[topicName].description =
        jsTopicDescriptions[topicName];
    }
  });
}

// Update JavaScript category description
topics.categories.JavaScript.description =
  'JavaScript - Programming language for web development: core concepts, ES6+ features, async programming, and advanced patterns';
...
console.log(
  `   JavaScript category: ${Object.keys(topics.categories.JavaScript.topics).length} topics`
);
