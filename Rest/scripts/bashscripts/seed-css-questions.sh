...
# CSS Questions Seeding Script
# This script clears existing questions and seeds CSS questions

echo "🎨 CSS Questions Seeding Process"
echo "================================"
...
# Seed CSS questions
echo ""
echo "🌱 Step 2: Seeding CSS questions..."
run_command "node scripts/seed-all-css-questions.js"

echo ""
echo "🎉 CSS Questions seeding completed successfully!"
