...
allQuestions.CSS = [
  generateQuestion(
    'css-1',
    'What is the difference between <code>transform</code> and changing <code>left/top</code> properties for animations?',
    'Why is transform preferred for animations over position properties?',
    'CSS',
    'Performance',
    [
      {
        text: 'transform uses GPU acceleration and does not trigger layout recalculation, left/top triggers layout and repaint',
        isCorrect: true,
      },
  ...
  generateQuestion(
    'css-2',
    'How does <code>content-visibility: auto</code> improve rendering performance?',
    'What is the mechanism behind content-visibility optimization?',
    'CSS',
    'Performance',
    [
      {
        text: 'It skips rendering for offscreen content, only rendering when it enters viewport',
        isCorrect: true,
      },
  ...
  generateQuestion(
    'css-3',
    'What is the difference between <code>will-change</code> and <code>transform: translateZ(0)</code> for GPU acceleration?',
    'How do these techniques differ in triggering hardware acceleration?',
    'CSS',
    'Performance',
    [
      {
        text: 'will-change hints future changes to the browser, translateZ(0) forces a new layer immediately',
        isCorrect: true,
      },
...
allQuestions.JavaScript = [
  generateQuestion(
    'js-1',
    'What is the difference between <code>Promise.all()</code> and <code>Promise.allSettled()</code>?',
    'How do these Promise methods handle rejected promises differently?',
    'JavaScript',
    'Async/Await',
    [
      {
        text: 'Promise.all() rejects immediately on first rejection, Promise.allSettled() waits for all promises regardless of outcome',
        isCorrect: true,
      },
      { text: 'They are identical', isCorrect: false },
      {
        text: 'Promise.allSettled() rejects on first failure',
        isCorrect: false,
      },
  ...
  generateQuestion(
    'js-2',
    'How does the <code>Proxy</code> object enable reactive programming patterns?',
    'What makes Proxy useful for implementing reactivity systems like Vue.js?',
    'JavaScript',
    'ES6+ Features',
    [
      {
        text: 'Proxy intercepts property access/setting, enabling automatic dependency tracking and updates',
        isCorrect: true,
      },
  ...
  generateQuestion(
    'js-3',
    'What is the difference between <code>Object.freeze()</code> and <code>Object.seal()</code>?',
    'How do these methods differ in preventing object modifications?',
    'JavaScript',
    'ES6+ Features',
    [
      {
        text: 'freeze() prevents all changes including property values, seal() allows changing values but not adding/removing properties',
        isCorrect: true,
      },
      { text: 'They are identical', isCorrect: false },
...
allQuestions.React = [
  generateQuestion(
    'react-1',
    'What is the difference between <code>useMemo</code> and <code>useCallback</code>?',
    'When should you use each hook for performance optimization?',
    'React',
    'Core React',
    [
      {
        text: 'useMemo memoizes computed values, useCallback memoizes function references',
        isCorrect: true,
      },
      { text: 'They are identical', isCorrect: false },
      {
        text: 'useMemo is for functions, useCallback is for values',
        isCorrect: false,
      },
  ...
  generateQuestion(
    'react-2',
    'How does React Fiber improve rendering performance compared to the old reconciler?',
    'What architectural changes enable incremental rendering in Fiber?',
    'React',
    'Core React',
    [
      {
        text: 'Fiber enables incremental rendering by breaking work into chunks and prioritizing updates',
        isCorrect: true,
      },
  ...
  generateQuestion(
    'react-3',
    'What is the purpose of <code>React.memo</code> and when should you use it?',
    'How does React.memo prevent unnecessary re-renders?',
    'React',
    'Core React',
    [
      {
        text: 'React.memo shallowly compares props and skips re-render if props are unchanged',
        isCorrect: true,
      },
...
allQuestions['Next.js'] = [
  generateQuestion(
    'next-1',
    'How does Next.js handle code splitting automatically?',
    'What is the mechanism behind automatic code splitting in Next.js?',
    'Next.js',
    'Optimization',
    [
      {
        text: 'Next.js splits code by route and component, creating separate chunks loaded on demand',
        isCorrect: true,
      },
  ...
  generateQuestion(
    'next-2',
    'What is the difference between <code>getStaticPaths</code> with <code>fallback: false</code> vs <code>fallback: true</code>?',
    'How do these fallback options affect SSG behavior?',
    'Next.js',
    'Static Site Generation (SSG)',
    [
      {
        text: 'fallback: false pre-renders all paths at build time, fallback: true allows on-demand generation for missing paths',
        isCorrect: true,
      },
      { text: 'They are identical', isCorrect: false },
  ...
  generateQuestion(
    'next-3',
    'How does Next.js middleware differ from API routes?',
    'When should you use middleware vs API routes?',
    'Next.js',
    'Middleware',
    [
      {
        text: 'Middleware runs before requests reach routes/API, API routes handle specific endpoints',
        isCorrect: true,
      },
      { text: 'They are identical', isCorrect: false },
...
allQuestions['Design Patterns'] = [
  generateQuestion(
    ...
    'How do these creational patterns differ in their complexity and use cases?',
    'Design Patterns',
    'Creational Patterns',
    [
      {
        text: 'Factory creates one type of object, Abstract Factory creates families of related objects',
        isCorrect: true,
      },
      { text: 'They are identical', isCorrect: false },
  ...
  generateQuestion(
    'dp-2',
    'How does the Observer Pattern enable event-driven architectures?',
    'What makes Observer Pattern suitable for decoupled communication?',
    'Design Patterns',
    'Behavioral Patterns',
    [
      {
        text: 'Observer allows objects to subscribe to events and be notified of changes without tight coupling',
        isCorrect: true,
      },
      {
        text: 'Observer requires direct references between objects',
        isCorrect: false,
      },
  ...
  generateQuestion(
    'dp-3',
    'What is the difference between Adapter Pattern and Decorator Pattern?',
    'How do these structural patterns differ in their purpose?',
    'Design Patterns',
    'Structural Patterns',
    [
      {
        text: 'Adapter changes interface to make incompatible classes work together, Decorator adds behavior without changing interface',
        isCorrect: true,
      },
      { text: 'They are identical', isCorrect: false },
...
allQuestions['Performance Patterns'] = [
  generateQuestion(
    'perf-1',
    'What is the PRPL pattern and how does it optimize web performance?',
    'How do Push, Render, Pre-cache, and Lazy-load work together?',
    'Performance Patterns',
    'PRPL Pattern',
    [
      {
        text: 'PRPL pushes critical resources, renders initial route, pre-caches remaining routes, lazy-loads as needed',
        isCorrect: true,
      },
      { text: 'PRPL is a CSS optimization technique', isCorrect: false },
      { text: 'PRPL only works with React', isCorrect: false },
      {
        text: 'PRPL stands for Performance, Render, Preload, Lazy',
        isCorrect: false,
      },
    ],
  ...
  generateQuestion(
    'perf-2',
    'How does tree shaking reduce bundle size?',
    'What mechanism enables dead code elimination in modern bundlers?',
    'Performance Patterns',
    'Code Optimization',
    [
      {
        text: 'Tree shaking analyzes import/export statements and removes unused code during bundling',
        isCorrect: true,
      },
      { text: 'Tree shaking removes comments from code', isCorrect: false },
      { text: 'Tree shaking only works with TypeScript', isCorrect: false },
      {
        text: 'Tree shaking requires manual configuration for each file',
        isCorrect: false,
      },
    ],
  ...
  generateQuestion(
    ...
    'How do these optimization techniques differ?',
    'Performance Patterns',
    'Code Splitting',
    [
      {
        text: 'Code splitting divides code into chunks, lazy loading loads chunks on demand',
        isCorrect: true,
      },
      { text: 'They are identical', isCorrect: false },
      { text: 'Lazy loading splits code automatically', isCorrect: false },
      {
        text: 'Code splitting only works with dynamic imports',
        isCorrect: false,
      },
    ],
...
allQuestions['Rendering Patterns'] = [
  generateQuestion(
    'rend-1',
    'What is the difference between Static Rendering and Server-Side Rendering?',
    'How do these rendering strategies differ in when and where HTML is generated?',
    'Rendering Patterns',
    'Static Rendering',
    [
      {
        text: 'Static Rendering generates HTML at build time, SSR generates HTML on each request',
        isCorrect: true,
      },
      { text: 'They are identical', isCorrect: false },
  ...
  generateQuestion(
    'rend-2',
    'How does Streaming Rendering improve perceived performance?',
    'What makes streaming better than waiting for full page render?',
    'Rendering Patterns',
    'Streaming Rendering',
    [
      {
        text: 'Streaming sends HTML incrementally as it renders, allowing progressive page display',
        isCorrect: true,
      },
  ...
  generateQuestion(
    'rend-3',
    'What is Progressive Hydration and how does it optimize interactivity?',
    'How does progressive hydration differ from full hydration?',
    'Rendering Patterns',
    'Progressive Hydration',
    [
      {
        text: 'Progressive Hydration hydrates components incrementally based on priority, reducing initial JS execution',
        isCorrect: true,
      },
      {
        text: 'Progressive Hydration hydrates everything at once',
        isCorrect: false,
      },
      { text: 'Progressive Hydration only works with React', isCorrect: false },
      {
        text: 'Progressive Hydration prevents interactivity',
        isCorrect: false,
      },
    ],
...
allQuestions.Security = [
  generateQuestion(
    ...
    'What mechanism does CSP use to block malicious scripts?',
    'Security',
    'Content Security Policy (CSP)',
    [
      {
        text: 'CSP whitelists allowed sources for scripts/styles, blocking inline scripts and unauthorized sources',
        isCorrect: true,
      },
  ...
  generateQuestion(
    'sec-2',
    'What is the difference between SameSite=Lax and SameSite=Strict for cookies?',
    'How do these SameSite values affect CSRF protection?',
    'Security',
    'CSRF',
    [
      {
        text: 'Strict blocks all cross-site requests, Lax allows GET requests from top-level navigation',
        isCorrect: true,
      },
      { text: 'They are identical', isCorrect: false },
  ...
  generateQuestion(
    'sec-3',
    'How does Subresource Integrity (SRI) protect against compromised CDN resources?',
    'What mechanism does SRI use to verify resource integrity?',
    'Security',
    'Web Security Fundamentals',
    [
      {
        text: 'SRI uses cryptographic hashes to verify that fetched resources match expected content',
        isCorrect: true,
      },
...
Object.entries(allQuestions).forEach(([category, questions]) => {
  ...
  console.log(
    `  ${category}: ${questions.length} questions → ${batches} batches`
  );
});
