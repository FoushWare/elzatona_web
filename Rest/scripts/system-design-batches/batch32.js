...
const newQuestions = [
  {
    ...
    "explanation": "Use SSE for unidirectional updates like live feeds, notifications, or stock tickers where client doesn't send frequent data and simplicity is preferred over bidirectional communication.",
    "points": 10,
    "options": [
      {
        "id": "o1",
  ...
  },
  {
    ...
    "explanation": "Browser cache stores assets locally on the client device. CDN cache stores assets on edge servers closer to the user. CDN reduces network latency while browser cache reduces repeated downloads.",
    "points": 10,
    "options": [
      {
        "id": "o1",
  ...
  },
  {
    ...
    "explanation": "Cache-control headers define how long and where a resource can be cached. Examples: <code>max-age</code>, <code>no-store</code>, <code>must-revalidate</code>. They help control freshness and prevent stale content.",
    "points": 10,
    "options": [
      {
        "id": "o1",
        ...
        "isCorrect": true,
        "explanation": "Cache-control headers define how long and where a resource can be cached. Examples: `max-age`, `no-store`, `must-revalidate`. They help control freshness and prevent stale content."
      },
      {
        "id": "o2",
...
console.log(`✅ Added ${newQuestions.length} system design questions (Batch 32)`);
