...
const newQuestions = [
  {
    ...
    "explanation": "Tree-shaking is the process of removing unused code from bundles during build time. It reduces bundle size and improves performance.",
    "points": 10,
    "options": [
      {
        "id": "o1",
  ...
  },
  {
    ...
    "explanation": "Ensure focusable elements use tabindex correctly, use semantic HTML elements, and manage focus state when modals or dialogs open.",
    "points": 10,
    "options": [
      {
        "id": "o1",
...
console.log(`✅ Added ${newQuestions.length} system design questions (Batch 4)`);
