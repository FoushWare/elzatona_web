...
const newQuestions = [
  {
    ...
    "explanation": "The correct answer is: JWT is self-contained, includes claims, can be verified without server",
    "points": 10,
    "options": [
      {
        "id": "o1",
  ...
  },
  {
    ...
    "explanation": "CORS is a browser security mechanism that controls which origins can access resources. It prevents unauthorized cross-origin requests.",
    "points": 10,
    "options": [
      {
        "id": "o1",
  ...
  },
  {
    ...
    "explanation": "Store tokens in HTTP-only cookies or in-memory storage, avoid localStorage for sensitive tokens, use short-lived tokens with refresh, and send via Authorization header.",
    "points": 10,
    "options": [
      {
        "id": "o1",
...
console.log(`✅ Added ${newQuestions.length} system design questions (Batch 24)`);
