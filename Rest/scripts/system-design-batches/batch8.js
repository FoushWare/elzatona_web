...
const newQuestions = [
  ...
  },
  {
    ...
    "explanation": "ARIA roles provide semantic information about elements to assistive technologies, improving accessibility for screen readers and keyboard navigation.",
    "points": 10,
    "options": [
      {
        "id": "o1",
  ...
  },
  {
    ...
    "explanation": "Semantic elements like <code>&lt;header&gt;</code>, <code>&lt;nav&gt;</code>, <code>&lt;main&gt;</code> provide meaning, improving navigation for assistive technologies.",
    "points": 10,
    "options": [
      {
        "id": "o1",
...
console.log(`✅ Added ${newQuestions.length} system design questions (Batch 8)`);
