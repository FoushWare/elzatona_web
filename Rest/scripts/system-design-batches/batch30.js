...
const newQuestions = [
  ...
  },
  {
    ...
    "explanation": "Implement exponential backoff retry, detect disconnections, optionally queue messages during downtime, and re-subscribe to channels after reconnect.",
    "points": 10,
    "options": [
      {
        "id": "o1",
  ...
  },
  {
    ...
    "explanation": "Throttle or debounce updates, batch multiple events into a single render, use virtualization for lists, and avoid unnecessary state updates.",
    "points": 10,
    "options": [
      {
        "id": "o1",
...
console.log(`✅ Added ${newQuestions.length} system design questions (Batch 30)`);
