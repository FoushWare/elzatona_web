...
const newQuestions = [
  {
    ...
    "explanation": "ARIA roles and attributes provide semantic information for assistive technologies. Use roles like <code>button</code>, <code>dialog</code>, and states like <code>aria-expanded</code> to convey meaning.",
    "points": 10,
    "options": [
      {
        "id": "o1",
        ...
        "isCorrect": true,
        "explanation": "ARIA roles and attributes provide semantic information for assistive technologies. Use roles like `button`, `dialog`, and states like `aria-expanded` to convey meaning."
      },
      {
        "id": "o2",
  ...
  },
  {
    ...
    "explanation": "Use browser extensions like Axe or WAVE, automated tools like Lighthouse, and manual testing with keyboard navigation and screen readers to ensure accessibility compliance.",
    "points": 10,
    "options": [
      {
        "id": "o1",
...
console.log(`✅ Added ${newQuestions.length} system design questions (Batch 26)`);
