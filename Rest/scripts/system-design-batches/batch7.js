...
const newQuestions = [
  {
    ...
    createdBy: 'admin',
    updatedBy: 'admin',
    tags: ['system-design', 'lazy-loading', 'beginner'],
    explanation:
    ...
    options: [
      {
        ...
        isCorrect: true,
        explanation:
          'Helps reduce initial load time and improves perceived performance.',
      },
      {
        id: '2',
...
console.log(
  `✅ Added ${newQuestions.length} system design questions (Batch 7)`
);
