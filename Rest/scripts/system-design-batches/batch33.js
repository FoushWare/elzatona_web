...
const newQuestions = [
  {
    ...
    "explanation": "A service worker is a script running in the background that intercepts network requests. It can cache assets, serve offline content, and enable push notifications for PWAs.",
    "points": 10,
    "options": [
      {
        "id": "o1",
  ...
  },
  {
    ...
    "explanation": "Stale-while-revalidate serves cached content immediately while fetching a fresh version in the background. The user sees fast responses while data stays up-to-date.",
    "points": 10,
    "options": [
      {
        "id": "o1",
...
console.log(`✅ Added ${newQuestions.length} system design questions (Batch 33)`);
