...
const newQuestions = [
  {
    ...
    "explanation": "WebSocket is a full-duplex, persistent connection between client and server for real-time communication. Use it for chat apps, notifications, and live feeds.",
    "points": 10,
    "options": [
      {
        "id": "o1",
  ...
  },
  {
    ...
    "explanation": "SSE is a unidirectional protocol where server pushes updates to the client over HTTP. Use SSE for live feeds or notifications where the client doesn't need to send frequent data.",
    "points": 10,
    "options": [
      {
        "id": "o1",
  ...
  },
  {
    ...
    "explanation": "Long polling is a technique where the client sends a request and the server holds it until data is available. Use it when WebSocket or SSE is not possible.",
    "points": 10,
    "options": [
      {
        "id": "o1",
...
console.log(`✅ Added ${newQuestions.length} system design questions (Batch 29)`);
