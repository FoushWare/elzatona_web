...
const newQuestions = [
  ...
  },
  {
    ...
    "explanation": "Context API is simple for small to medium apps with minimal boilerplate, but can cause re-renders. Redux provides structured state management and debugging tools, better for complex apps.",
    "points": 10,
    "options": [
      {
        "id": "o1",
...
console.log(`✅ Added ${newQuestions.length} system design questions (Batch 2)`);
