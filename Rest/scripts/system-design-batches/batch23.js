...
const newQuestions = [
  {
    ...
    "explanation": "Escape or sanitize user-generated content, use Content Security Policy (CSP), avoid <code>innerHTML</code>, and validate input on both frontend and backend.",
    "points": 10,
    "options": [
      {
        "id": "o1",
        ...
        "isCorrect": true,
        "explanation": "Escape or sanitize user-generated content, use Content Security Policy (CSP), avoid `innerHTML`, and validate input on both frontend and backend."
      },
      {
        "id": "o2",
        "text": "Escape or sanitize user-generated content, use Content Security Policy (CSP), avoid `innerHTML`, and validate input on both frontend and backend",
  ...
  },
  {
    ...
    "explanation": "HTTP-only cookies cannot be accessed by JavaScript, reducing the risk of XSS attacks stealing session data.",
    "points": 10,
    "options": [
      {
        "id": "o1",
  ...
  },
  {
    ...
    "explanation": "Use tokens (JWT or opaque), store securely in HTTP-only cookies or local storage, handle token refresh, and validate session on API requests.",
    "points": 10,
    "options": [
      {
        "id": "o1",
...
console.log(`✅ Added ${newQuestions.length} system design questions (Batch 23)`);
