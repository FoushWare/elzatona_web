...
const newQuestions = [
  ...
  },
  {
    ...
    createdBy: 'admin',
    updatedBy: 'admin',
    tags: ['system-design', 'rendering-strategies', 'intermediate'],
    explanation:
    ...
    options: [
      {
        ...
        isCorrect: true,
        explanation:
          'CSR delays first render but enables rich interactivity; SSR improves SEO and first load but adds server cost; SSG is best for static content with CDN delivery.',
      },
      {
        id: '2',
  ...
  },
  {
    ...
    createdBy: 'admin',
    updatedBy: 'admin',
    tags: ['system-design', 'caching', 'intermediate'],
    explanation:
...
console.log(
  `✅ Added ${newQuestions.length} system design questions (Batch 6)`
);
