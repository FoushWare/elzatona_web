# Test Report: S-001 - Navigation Component
...
1. `libs/shared-components/src/lib/common/Navigation.test.tsx` - Unit tests
2. `libs/shared-components/src/lib/common/Navigation.integration.test.tsx` - Integration tests
3. `tests/e2e/shared-components/navigation.spec.ts` - E2E tests
