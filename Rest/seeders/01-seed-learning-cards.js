...
const learningCards = [
  ...
  },
  {
    title: 'System Design',
    type: 'system-design',
    description: 'System architecture, performance, rendering, and security patterns',
    icon: '🏗️',
    color: '#9B59B6',
    order_index: 3
  },
...
async function seedLearningCards() {
  ...
  console.log('⚠️  Note: If "frontend-tasks" type fails, you may need to update the schema constraint\n');
