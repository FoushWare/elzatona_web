...
import { LearningPlanTemplate } from '@elzatona/data/firebase';
    ...
    const loadTemplates = async () => {
      ...
      try {
        ...
        if (
          ...
          console.log(
            '✅ SimpleHook: Successfully loaded templates from API:',
        ...
        console.error(
          '❌ SimpleHook: Error loading learning plan templates:',
          error
        );
        setError(
