...
describe('IFlashcardRepository', () => {
  ...
  it('createFlashcard with sectionId reference', async () => {
    const newFlashcard = await flashcardRepository.createFlashcard({ question: 'Q3', answer: 'A3', sectionId: '1' });
  ...
  it('updateFlashcard updates existing flashcard', async () => {
    const updated = await flashcardRepository.updateFlashcard('1', { question: 'Q1 updated', answer: 'A1', sectionId: '1' });
