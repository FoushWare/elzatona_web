  ...
  return (
    ...
    >
      <div className='w-full px-4 sm:px-6 lg:px-8'>
        ...
        {isOpen && (
          <div 
            className='lg:hidden fixed top-0 left-0 right-0 bottom-0 bg-white dark:bg-gray-800 z-[100] overflow-y-auto pt-16'
          >
            ...
            <div className='sticky top-0 bg-white dark:bg-gray-800 z-[101] border-b border-gray-200 dark:border-gray-700'>
              <div className='flex items-center justify-between px-4 py-4'>
                ...
                <div className='flex items-center'>
                  <p className='text-xl font-bold text-gray-900 dark:text-white'>Admin Menu</p>
                </div>
