...
<<<<<<<< HEAD:libs/hooks/src/lib/useImageOptimization.ts
...
>>>>>>>> origin/security/fix-gitleaks-config:codeql-database/src/Users/a.fouad/S/New_elzatona/libs/hooks/src/lib/useImageOptimization.ts
      ? "webp"
      : "jpeg";
  }
  return "webp";
